...
public struct ActionType: Codable, Hashable {
    ...
    public init(id: String, spaceName: String, created: Date, customFields: [String: AnyCodable]? = nil, tags: [String]? = nil, metadata: [String: String]? = nil, name: String, key: String, description: String? = nil, constraints: [String], unitOfMeasure: String) {
        self.id = id
