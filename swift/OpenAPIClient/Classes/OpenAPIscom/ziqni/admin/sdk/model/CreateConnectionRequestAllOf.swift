//
// CreateConnectionRequestAllOf.swift
//
...
public struct CreateConnectionRequestAllOf: Codable, Hashable {
    ...
    public init(name: String, description: String? = nil, constraints: [String]? = nil, transformerId: String? = nil, connectionType: ConnectionType, secret: String? = nil, user: String? = nil) {
        self.name = name
