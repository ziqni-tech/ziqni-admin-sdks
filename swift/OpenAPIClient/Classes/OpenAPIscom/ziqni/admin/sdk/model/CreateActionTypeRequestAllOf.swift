//
// CreateActionTypeRequestAllOf.swift
//
...
public struct CreateActionTypeRequestAllOf: Codable, Hashable {
    ...
    public init(name: String, key: String, description: String? = nil, addConstraints: [String]? = nil, unitOfMeasure: String) {
        self.name = name
        self.key = key
