...
public struct CreateRewardRequest: Codable, Hashable {
    ...
    public init(customFields: [String: AnyCodable]? = nil, tags: [String]? = nil, metadata: [String: String]? = nil, name: String, description: String? = nil, rewardRank: String, rewardValue: Double, icon: String? = nil, issueLimit: Int? = nil, delay: Int, pointInTime: Date? = nil, period: Int? = nil, translations: [Translation]? = nil, addConstraints: [String]? = nil, rewardTypeId: String) {
