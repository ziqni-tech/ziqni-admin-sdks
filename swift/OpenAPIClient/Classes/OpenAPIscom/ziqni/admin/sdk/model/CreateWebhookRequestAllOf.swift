//
// CreateWebhookRequestAllOf.swift
//
...
public struct CreateWebhookRequestAllOf: Codable, Hashable {
    ...
    public init(postToUrl: String, triggers: [String], description: String? = nil, name: String, headers: [String: String]? = nil) {
