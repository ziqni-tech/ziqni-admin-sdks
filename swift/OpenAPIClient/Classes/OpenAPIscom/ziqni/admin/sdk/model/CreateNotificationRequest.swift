...
public struct CreateNotificationRequest: Codable, Hashable {
    ...
    public init(customFields: [String: AnyCodable]? = nil, tags: [String]? = nil, metadata: [String: String]? = nil, messageType: MessageType, subject: String, body: String, status: MessageStatus, translations: [Translation]? = nil, scheduling: Scheduling, constraints: [String], memberTags: [String]? = nil, memberIds: [String]? = nil, expireAfterDate: Date? = nil, expireAfterDays: Int? = nil) {
