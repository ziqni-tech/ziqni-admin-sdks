//
// CreateEntityRewardRequest.swift
//
...
public struct CreateEntityRewardRequest: Codable, Hashable {
    ...
    public init(customFields: [String: AnyCodable]? = nil, tags: [String]? = nil, metadata: [String: String]? = nil, entityType: RewardEntityType, entityId: String, name: String, description: String? = nil, rewardRank: String, rewardValue: Double, icon: String? = nil, issueLimit: Int? = nil, delay: Int? = nil, pointInTime: Date? = nil, period: Int? = nil, translations: [Translation]? = nil, constraints: [String], rewardTypeId: String) {
