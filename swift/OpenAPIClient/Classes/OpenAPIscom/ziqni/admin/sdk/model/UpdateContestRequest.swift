...
public struct UpdateContestRequest: Codable, Hashable {
    ...
    public init(id: String, customFields: [String: AnyCodable]? = nil, tags: [String]? = nil, metadata: [String: String]? = nil, name: String? = nil, description: String? = nil, termsAndConditions: String? = nil, roundType: RoundType? = nil, maxNumberOfEntrants: Int? = nil, minNumberOfEntrants: Int? = nil, scheduledStartDate: Date? = nil, scheduledEndDate: Date? = nil, strategies: Strategy? = nil, constraints: [String]? = nil) {
        self.id = id
