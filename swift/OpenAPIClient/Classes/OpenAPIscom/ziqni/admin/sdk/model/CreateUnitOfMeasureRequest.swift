//
// CreateUnitOfMeasureRequest.swift
//
...
public struct CreateUnitOfMeasureRequest: Codable, Hashable {
    ...
    public init(customFields: [String: AnyCodable]? = nil, tags: [String]? = nil, metadata: [String: String]? = nil, name: String, key: String, description: String? = nil, isoCode: String? = nil, symbol: String? = nil, multiplier: Double, unitOfMeasureType: UnitOfMeasureType) {
