...
public struct Award: Codable, Hashable {
    ...
    public init(id: String, spaceName: String, created: Date, memberId: String, rewardId: String, rewardType: RewardTypeReduced, rewardRank: String, rewardValue: Double, delay: Int? = nil, entityType: EntityType, entityId: String, pointInTime: Date? = nil, period: Int? = nil, tags: [String]? = nil, metadata: [String: String]? = nil, constraints: [String], claimedTimestamp: Date? = nil, memberRefId: String? = nil) {
        self.id = id
