...
public struct ContestReduced: Codable, Hashable {
    ...
    public init(id: String, spaceName: String, created: Date, competitionId: String, row: Int, name: String, round: Int, groupStage: Int, entrantsFromContest: [String], status: ContestStatus, statusCode: Int, scheduledStartDate: Date, scheduledEndDate: Date, actualStartDate: Date? = nil, actualEndDate: Date? = nil, tags: [String]? = nil, rewards: [RewardReduced]? = nil) {
        self.id = id
