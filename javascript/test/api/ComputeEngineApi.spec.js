...
(function(root, factory) {
  ...
  describe('ComputeEngineApi', function() {
    ...
    describe('updateComputeEnginesState', function() {
      it('should call updateComputeEnginesState successfully', function(done) {
        //uncomment below and update the code to test updateComputeEnginesState
        //instance.updateComputeEnginesState(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
