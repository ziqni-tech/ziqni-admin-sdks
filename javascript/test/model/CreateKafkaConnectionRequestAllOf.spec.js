...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateKafkaConnectionRequestAllOf();
  });
  ...
  describe('CreateKafkaConnectionRequestAllOf', function() {
    it('should create an instance of CreateKafkaConnectionRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateKafkaConnectionRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateKafkaConnectionRequestAllOf);
    });
