...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.RankingStrategy();
  });
  ...
  describe('RankingStrategy', function() {
    it('should create an instance of RankingStrategy', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.RankingStrategy();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.RankingStrategy);
    });
