...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateApiKeyRequestAllOf();
  });
  ...
  describe('UpdateApiKeyRequestAllOf', function() {
    it('should create an instance of UpdateApiKeyRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateApiKeyRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateApiKeyRequestAllOf);
    });
