...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.AchievementIssuedCount();
  });
  ...
  describe('AchievementIssuedCount', function() {
    it('should create an instance of AchievementIssuedCount', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.AchievementIssuedCount();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.AchievementIssuedCount);
    });
