...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateTranslationRequestAllOf();
  });
  ...
  describe('UpdateTranslationRequestAllOf', function() {
    it('should create an instance of UpdateTranslationRequestAllOf', function() {
      // uncomment below and update the code to test UpdateTranslationRequestAllOf
      //var instance = new @ZiqniTechAdminApiClient.UpdateTranslationRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateTranslationRequestAllOf);
    });
