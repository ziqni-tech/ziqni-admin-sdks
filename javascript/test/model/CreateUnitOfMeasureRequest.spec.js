...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateUnitOfMeasureRequest();
  });
  ...
  describe('CreateUnitOfMeasureRequest', function() {
    it('should create an instance of CreateUnitOfMeasureRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateUnitOfMeasureRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateUnitOfMeasureRequest);
    });
