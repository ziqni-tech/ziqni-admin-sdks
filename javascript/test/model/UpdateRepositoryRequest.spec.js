...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateRepositoryRequest();
  });
  ...
  describe('UpdateRepositoryRequest', function() {
    it('should create an instance of UpdateRepositoryRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateRepositoryRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateRepositoryRequest);
    });
