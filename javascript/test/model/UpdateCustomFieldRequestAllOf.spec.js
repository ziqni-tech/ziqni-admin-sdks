...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateCustomFieldRequestAllOf();
  });
  ...
  describe('UpdateCustomFieldRequestAllOf', function() {
    it('should create an instance of UpdateCustomFieldRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateCustomFieldRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateCustomFieldRequestAllOf);
    });
