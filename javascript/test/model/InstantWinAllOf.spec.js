...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.InstantWinAllOf();
  });
  ...
  describe('InstantWinAllOf', function() {
    it('should create an instance of InstantWinAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.InstantWinAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.InstantWinAllOf);
    });
    ...
    it('should have the property playedCount (base name: "playedCount")', function() {
      // uncomment below and update the code to test the property playedCount
      //var instance = new @ZiqniTechAdminApiClient.InstantWinAllOf();
      //expect(instance).to.be();
    });
