...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CountResponse();
  });
  ...
  describe('CountResponse', function() {
    it('should create an instance of CountResponse', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CountResponse();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CountResponse);
    });
