...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.Relation();
  });
  ...
  describe('Relation', function() {
    it('should create an instance of Relation', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.Relation();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.Relation);
    });
