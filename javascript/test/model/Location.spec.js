...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.Location();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.Location);
    });
