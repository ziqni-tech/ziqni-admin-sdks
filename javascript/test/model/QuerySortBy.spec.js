...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.QuerySortBy();
  });
  ...
  describe('QuerySortBy', function() {
    it('should create an instance of QuerySortBy', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.QuerySortBy();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.QuerySortBy);
    });
