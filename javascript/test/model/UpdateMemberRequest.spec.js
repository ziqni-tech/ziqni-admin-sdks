...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateMemberRequest();
  });
  ...
  describe('UpdateMemberRequest', function() {
    it('should create an instance of UpdateMemberRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateMemberRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateMemberRequest);
    });
