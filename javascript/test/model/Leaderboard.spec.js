...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.Leaderboard();
  });
  ...
  describe('Leaderboard', function() {
    it('should create an instance of Leaderboard', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.Leaderboard();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.Leaderboard);
    });
