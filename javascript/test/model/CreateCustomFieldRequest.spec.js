...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateCustomFieldRequest();
  });
  ...
  describe('CreateCustomFieldRequest', function() {
    it('should create an instance of CreateCustomFieldRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateCustomFieldRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateCustomFieldRequest);
    });
