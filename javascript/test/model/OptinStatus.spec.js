...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.OptinStatus();
  });
  ...
  describe('OptinStatus', function() {
    it('should create an instance of OptinStatus', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.OptinStatus();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.OptinStatus);
    });
