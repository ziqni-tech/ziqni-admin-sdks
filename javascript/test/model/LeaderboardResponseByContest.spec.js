...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.LeaderboardResponseByContest();
  });
  ...
  describe('LeaderboardResponseByContest', function() {
    it('should create an instance of LeaderboardResponseByContest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.LeaderboardResponseByContest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.LeaderboardResponseByContest);
    });
