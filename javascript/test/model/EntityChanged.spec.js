...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.EntityChanged();
  });
  ...
  describe('EntityChanged', function() {
    it('should create an instance of EntityChanged', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.EntityChanged();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.EntityChanged);
    });
