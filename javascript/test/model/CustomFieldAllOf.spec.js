...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CustomFieldAllOf();
  });
  ...
  describe('CustomFieldAllOf', function() {
    it('should create an instance of CustomFieldAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CustomFieldAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CustomFieldAllOf);
    });
