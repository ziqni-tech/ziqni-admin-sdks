...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.EventResponse();
  });
  ...
  describe('EventResponse', function() {
    it('should create an instance of EventResponse', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.EventResponse();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.EventResponse);
    });
