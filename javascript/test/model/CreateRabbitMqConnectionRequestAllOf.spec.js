...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateRabbitMqConnectionRequestAllOf();
  });
  ...
  describe('CreateRabbitMqConnectionRequestAllOf', function() {
    it('should create an instance of CreateRabbitMqConnectionRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateRabbitMqConnectionRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateRabbitMqConnectionRequestAllOf);
    });
