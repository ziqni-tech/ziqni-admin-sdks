...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateRewardTypeRequestAllOf();
  });
  ...
  describe('CreateRewardTypeRequestAllOf', function() {
    it('should create an instance of CreateRewardTypeRequestAllOf', function() {
      // uncomment below and update the code to test CreateRewardTypeRequestAllOf
      //var instance = new @ZiqniTechAdminApiClient.CreateRewardTypeRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateRewardTypeRequestAllOf);
    });
