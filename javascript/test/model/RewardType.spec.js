...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.RewardType();
  });
  ...
  describe('RewardType', function() {
    it('should create an instance of RewardType', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.RewardType();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.RewardType);
    });
