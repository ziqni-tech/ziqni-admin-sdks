...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateInstantWinRequestAllOf();
  });
  ...
  describe('CreateInstantWinRequestAllOf', function() {
    it('should create an instance of CreateInstantWinRequestAllOf', function() {
      // uncomment below and update the code to test CreateInstantWinRequestAllOf
      //var instance = new @ZiqniTechAdminApiClient.CreateInstantWinRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateInstantWinRequestAllOf);
    });
