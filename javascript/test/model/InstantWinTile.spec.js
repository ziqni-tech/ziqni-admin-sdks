...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.InstantWinTile();
  });
  ...
  describe('InstantWinTile', function() {
    it('should create an instance of InstantWinTile', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.InstantWinTile();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.InstantWinTile);
    });
