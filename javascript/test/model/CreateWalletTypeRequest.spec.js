...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateWalletTypeRequest();
  });
  ...
  describe('CreateWalletTypeRequest', function() {
    it('should create an instance of CreateWalletTypeRequest', function() {
      // uncomment below and update the code to test CreateWalletTypeRequest
      //var instance = new @ZiqniTechAdminApiClient.CreateWalletTypeRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateWalletTypeRequest);
    });
