...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateContestStateRequest();
  });
  ...
  describe('UpdateContestStateRequest', function() {
    it('should create an instance of UpdateContestStateRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateContestStateRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateContestStateRequest);
    });
