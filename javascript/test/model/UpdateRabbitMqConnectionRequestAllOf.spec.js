...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateRabbitMqConnectionRequestAllOf();
  });
  ...
  describe('UpdateRabbitMqConnectionRequestAllOf', function() {
    it('should create an instance of UpdateRabbitMqConnectionRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateRabbitMqConnectionRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateRabbitMqConnectionRequestAllOf);
    });
