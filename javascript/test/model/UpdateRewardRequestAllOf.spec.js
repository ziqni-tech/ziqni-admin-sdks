...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateRewardRequestAllOf();
  });
  ...
  describe('UpdateRewardRequestAllOf', function() {
    it('should create an instance of UpdateRewardRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateRewardRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateRewardRequestAllOf);
    });
