...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateApiKeyRequest();
  });
  ...
  describe('UpdateApiKeyRequest', function() {
    it('should create an instance of UpdateApiKeyRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateApiKeyRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateApiKeyRequest);
    });
