...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateSpaceRequest();
  });
  ...
  describe('UpdateSpaceRequest', function() {
    it('should create an instance of UpdateSpaceRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateSpaceRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateSpaceRequest);
    });
