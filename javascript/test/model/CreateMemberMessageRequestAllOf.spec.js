...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateMemberMessageRequestAllOf();
  });
  ...
  describe('CreateMemberMessageRequestAllOf', function() {
    it('should create an instance of CreateMemberMessageRequestAllOf', function() {
      // uncomment below and update the code to test CreateMemberMessageRequestAllOf
      //var instance = new @ZiqniTechAdminApiClient.CreateMemberMessageRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateMemberMessageRequestAllOf);
    });
