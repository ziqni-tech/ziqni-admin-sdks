...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.MetaBasic();
  });
  ...
  describe('MetaBasic', function() {
    it('should create an instance of MetaBasic', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.MetaBasic();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.MetaBasic);
    });
