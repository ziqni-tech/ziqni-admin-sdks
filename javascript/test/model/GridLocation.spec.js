...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.GridLocation();
  });
  ...
  describe('GridLocation', function() {
    it('should create an instance of GridLocation', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.GridLocation();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.GridLocation);
    });
