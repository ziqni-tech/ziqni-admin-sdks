...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.ModelDefault();
  });
  ...
  describe('ModelDefault', function() {
    it('should create an instance of ModelDefault', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.ModelDefault();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.ModelDefault);
    });
