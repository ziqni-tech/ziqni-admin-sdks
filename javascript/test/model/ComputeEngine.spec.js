...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.ComputeEngine();
  });
  ...
  describe('ComputeEngine', function() {
    it('should create an instance of ComputeEngine', function() {
      // uncomment below and update the code to test ComputeEngine
      //var instance = new @ZiqniTechAdminApiClient.ComputeEngine();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.ComputeEngine);
    });
