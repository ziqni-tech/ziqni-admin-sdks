...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateWalletTypeRequest();
  });
  ...
  describe('UpdateWalletTypeRequest', function() {
    it('should create an instance of UpdateWalletTypeRequest', function() {
      // uncomment below and update the code to test UpdateWalletTypeRequest
      //var instance = new @ZiqniTechAdminApiClient.UpdateWalletTypeRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateWalletTypeRequest);
    });
