...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateEventRequest();
  });
  ...
  describe('CreateEventRequest', function() {
    it('should create an instance of CreateEventRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateEventRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateEventRequest);
    });
