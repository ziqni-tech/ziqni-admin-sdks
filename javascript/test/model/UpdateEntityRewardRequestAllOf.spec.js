...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateEntityRewardRequestAllOf();
  });
  ...
  describe('UpdateEntityRewardRequestAllOf', function() {
    it('should create an instance of UpdateEntityRewardRequestAllOf', function() {
      // uncomment below and update the code to test UpdateEntityRewardRequestAllOf
      //var instance = new @ZiqniTechAdminApiClient.UpdateEntityRewardRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateEntityRewardRequestAllOf);
    });
