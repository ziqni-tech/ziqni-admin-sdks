...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateContestRequestAllOf();
  });
  ...
  describe('UpdateContestRequestAllOf', function() {
    it('should create an instance of UpdateContestRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateContestRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateContestRequestAllOf);
    });
