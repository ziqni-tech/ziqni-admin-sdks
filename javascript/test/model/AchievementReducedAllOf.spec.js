...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.AchievementReducedAllOf();
  });
  ...
  describe('AchievementReducedAllOf', function() {
    it('should create an instance of AchievementReducedAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.AchievementReducedAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.AchievementReducedAllOf);
    });
