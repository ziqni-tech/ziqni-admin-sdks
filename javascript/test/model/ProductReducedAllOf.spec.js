...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.ProductReducedAllOf();
  });
  ...
  describe('ProductReducedAllOf', function() {
    it('should create an instance of ProductReducedAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.ProductReducedAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.ProductReducedAllOf);
    });
