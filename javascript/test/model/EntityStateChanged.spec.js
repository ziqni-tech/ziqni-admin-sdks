...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.EntityStateChanged();
  });
  ...
  describe('EntityStateChanged', function() {
    it('should create an instance of EntityStateChanged', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.EntityStateChanged();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.EntityStateChanged);
    });
