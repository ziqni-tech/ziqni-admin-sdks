...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateKafkaConnectionRequest();
  });
  ...
  describe('CreateKafkaConnectionRequest', function() {
    it('should create an instance of CreateKafkaConnectionRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateKafkaConnectionRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateKafkaConnectionRequest);
    });
