...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.AwardAllOf();
  });
  ...
  describe('AwardAllOf', function() {
    it('should create an instance of AwardAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.AwardAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.AwardAllOf);
    });
