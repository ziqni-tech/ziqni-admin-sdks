...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.AccountMessageAllOf();
  });
  ...
  describe('AccountMessageAllOf', function() {
    it('should create an instance of AccountMessageAllOf', function() {
      // uncomment below and update the code to test AccountMessageAllOf
      //var instance = new @ZiqniTechAdminApiClient.AccountMessageAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.AccountMessageAllOf);
    });
