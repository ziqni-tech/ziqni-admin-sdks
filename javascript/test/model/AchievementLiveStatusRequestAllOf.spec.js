...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.AchievementLiveStatusRequestAllOf();
  });
  ...
  describe('AchievementLiveStatusRequestAllOf', function() {
    it('should create an instance of AchievementLiveStatusRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.AchievementLiveStatusRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.AchievementLiveStatusRequestAllOf);
    });
