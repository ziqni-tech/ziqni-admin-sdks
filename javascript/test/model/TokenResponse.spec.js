...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.TokenResponse();
  });
  ...
  describe('TokenResponse', function() {
    it('should create an instance of TokenResponse', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.TokenResponse();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.TokenResponse);
    });
