...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.ConnectionAllOf();
  });
  ...
  describe('ConnectionAllOf', function() {
    it('should create an instance of ConnectionAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.ConnectionAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.ConnectionAllOf);
    });
