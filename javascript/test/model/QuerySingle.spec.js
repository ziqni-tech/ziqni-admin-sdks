...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.QuerySingle();
  });
  ...
  describe('QuerySingle', function() {
    it('should create an instance of QuerySingle', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.QuerySingle();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.QuerySingle);
    });
