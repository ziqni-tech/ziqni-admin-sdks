...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateWalletRequest();
  });
  ...
  describe('CreateWalletRequest', function() {
    it('should create an instance of CreateWalletRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateWalletRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateWalletRequest);
    });
