...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.SqsConnection();
  });
  ...
  describe('SqsConnection', function() {
    it('should create an instance of SqsConnection', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.SqsConnection();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.SqsConnection);
    });
