...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.AccountMessage();
  });
  ...
  describe('AccountMessage', function() {
    it('should create an instance of AccountMessage', function() {
      // uncomment below and update the code to test AccountMessage
      //var instance = new @ZiqniTechAdminApiClient.AccountMessage();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.AccountMessage);
    });
