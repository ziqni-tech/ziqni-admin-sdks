...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateSqsConnectionRequest();
  });
  ...
  describe('UpdateSqsConnectionRequest', function() {
    it('should create an instance of UpdateSqsConnectionRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateSqsConnectionRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateSqsConnectionRequest);
    });
