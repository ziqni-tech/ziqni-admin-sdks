...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.KafkaConnectionAllOf();
  });
  ...
  describe('KafkaConnectionAllOf', function() {
    it('should create an instance of KafkaConnectionAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.KafkaConnectionAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.KafkaConnectionAllOf);
    });
