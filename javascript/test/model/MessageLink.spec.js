...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.MessageLink();
  });
  ...
  describe('MessageLink', function() {
    it('should create an instance of MessageLink', function() {
      // uncomment below and update the code to test MessageLink
      //var instance = new @ZiqniTechAdminApiClient.MessageLink();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.MessageLink);
    });
