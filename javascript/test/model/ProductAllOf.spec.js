...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.ProductAllOf();
  });
  ...
  describe('ProductAllOf', function() {
    it('should create an instance of ProductAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.ProductAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.ProductAllOf);
    });
