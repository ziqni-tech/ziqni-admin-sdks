...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.RabbitMqConnection();
  });
  ...
  describe('RabbitMqConnection', function() {
    it('should create an instance of RabbitMqConnection', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.RabbitMqConnection();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.RabbitMqConnection);
    });
