...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.MemberAward();
  });
  ...
  describe('MemberAward', function() {
    it('should create an instance of MemberAward', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.MemberAward();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.MemberAward);
    });
