...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateInstantWinRequest();
  });
  ...
  describe('CreateInstantWinRequest', function() {
    it('should create an instance of CreateInstantWinRequest', function() {
      // uncomment below and update the code to test CreateInstantWinRequest
      //var instance = new @ZiqniTechAdminApiClient.CreateInstantWinRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateInstantWinRequest);
    });
