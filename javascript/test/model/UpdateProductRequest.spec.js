...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateProductRequest();
  });
  ...
  describe('UpdateProductRequest', function() {
    it('should create an instance of UpdateProductRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateProductRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateProductRequest);
    });
