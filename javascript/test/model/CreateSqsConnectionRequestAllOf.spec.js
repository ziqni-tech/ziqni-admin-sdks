...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateSqsConnectionRequestAllOf();
  });
  ...
  describe('CreateSqsConnectionRequestAllOf', function() {
    it('should create an instance of CreateSqsConnectionRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateSqsConnectionRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateSqsConnectionRequestAllOf);
    });
