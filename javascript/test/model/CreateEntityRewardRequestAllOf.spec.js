...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateEntityRewardRequestAllOf();
  });
  ...
  describe('CreateEntityRewardRequestAllOf', function() {
    it('should create an instance of CreateEntityRewardRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateEntityRewardRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateEntityRewardRequestAllOf);
    });
