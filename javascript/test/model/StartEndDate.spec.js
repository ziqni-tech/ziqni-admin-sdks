...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.StartEndDate();
  });
  ...
  describe('StartEndDate', function() {
    it('should create an instance of StartEndDate', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.StartEndDate();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.StartEndDate);
    });
