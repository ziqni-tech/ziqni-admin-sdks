...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.TranslatedField();
  });
  ...
  describe('TranslatedField', function() {
    it('should create an instance of TranslatedField', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.TranslatedField();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.TranslatedField);
    });
