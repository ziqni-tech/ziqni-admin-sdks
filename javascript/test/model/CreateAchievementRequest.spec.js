...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateAchievementRequest();
  });
  ...
  describe('CreateAchievementRequest', function() {
    it('should create an instance of CreateAchievementRequest', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.CreateAchievementRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateAchievementRequest);
    });
