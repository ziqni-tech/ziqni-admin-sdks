...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateInstantWinTile();
  });
  ...
  describe('UpdateInstantWinTile', function() {
    it('should create an instance of UpdateInstantWinTile', function() {
      // uncomment below and update the code to test UpdateInstantWinTile
      //var instance = new @ZiqniTechAdminApiClient.UpdateInstantWinTile();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateInstantWinTile);
    });
