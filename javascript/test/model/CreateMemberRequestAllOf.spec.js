...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateMemberRequestAllOf();
  });
  ...
  describe('CreateMemberRequestAllOf', function() {
    it('should create an instance of CreateMemberRequestAllOf', function() {
      // uncomment below and update the code to test CreateMemberRequestAllOf
      //var instance = new @ZiqniTechAdminApiClient.CreateMemberRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateMemberRequestAllOf);
    });
