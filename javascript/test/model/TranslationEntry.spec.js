...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.TranslationEntry();
  });
  ...
  describe('TranslationEntry', function() {
    it('should create an instance of TranslationEntry', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.TranslationEntry();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.TranslationEntry);
    });
