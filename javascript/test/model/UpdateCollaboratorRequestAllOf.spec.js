...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateCollaboratorRequestAllOf();
  });
  ...
  describe('UpdateCollaboratorRequestAllOf', function() {
    it('should create an instance of UpdateCollaboratorRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateCollaboratorRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateCollaboratorRequestAllOf);
    });
