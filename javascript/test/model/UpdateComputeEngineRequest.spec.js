...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateComputeEngineRequest();
  });
  ...
  describe('UpdateComputeEngineRequest', function() {
    it('should create an instance of UpdateComputeEngineRequest', function() {
      // uncomment below and update the code to test UpdateComputeEngineRequest
      //var instance = new @ZiqniTechAdminApiClient.UpdateComputeEngineRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateComputeEngineRequest);
    });
