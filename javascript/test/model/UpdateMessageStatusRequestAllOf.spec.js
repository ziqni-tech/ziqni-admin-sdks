...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.UpdateMessageStatusRequestAllOf();
  });
  ...
  describe('UpdateMessageStatusRequestAllOf', function() {
    it('should create an instance of UpdateMessageStatusRequestAllOf', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.UpdateMessageStatusRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.UpdateMessageStatusRequestAllOf);
    });
