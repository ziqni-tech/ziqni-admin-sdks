...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.AchievementResponse();
  });
  ...
  describe('AchievementResponse', function() {
    it('should create an instance of AchievementResponse', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.AchievementResponse();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.AchievementResponse);
    });
