...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.MetaInfo();
  });
  ...
  describe('MetaInfo', function() {
    it('should create an instance of MetaInfo', function() {
      ...
      //var instance = new @ZiqniTechAdminApiClient.MetaInfo();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.MetaInfo);
    });
