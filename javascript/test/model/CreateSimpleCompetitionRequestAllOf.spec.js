...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateSimpleCompetitionRequestAllOf();
  });
  ...
  describe('CreateSimpleCompetitionRequestAllOf', function() {
    it('should create an instance of CreateSimpleCompetitionRequestAllOf', function() {
      // uncomment below and update the code to test CreateSimpleCompetitionRequestAllOf
      //var instance = new @ZiqniTechAdminApiClient.CreateSimpleCompetitionRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateSimpleCompetitionRequestAllOf);
    });
