...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateUnitOfMeasureRequestAllOf();
  });
  ...
  describe('CreateUnitOfMeasureRequestAllOf', function() {
    it('should create an instance of CreateUnitOfMeasureRequestAllOf', function() {
      // uncomment below and update the code to test CreateUnitOfMeasureRequestAllOf
      //var instance = new @ZiqniTechAdminApiClient.CreateUnitOfMeasureRequestAllOf();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateUnitOfMeasureRequestAllOf);
    });
