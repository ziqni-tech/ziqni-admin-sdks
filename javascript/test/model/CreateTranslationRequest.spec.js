...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechAdminApiClient.CreateTranslationRequest();
  });
  ...
  describe('CreateTranslationRequest', function() {
    it('should create an instance of CreateTranslationRequest', function() {
      // uncomment below and update the code to test CreateTranslationRequest
      //var instance = new @ZiqniTechAdminApiClient.CreateTranslationRequest();
      //expect(instance).to.be.a(@ZiqniTechAdminApiClient.CreateTranslationRequest);
    });
