...
export default class InstantWinsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getInstantWinEntrants operation.
     * @callback module:api/InstantWinsApi~getInstantWinEntrantsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InstantWinMemberResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/InstantWinsApi~getInstantWinEntrantsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InstantWinMemberResponse}
     */
    getInstantWinEntrants(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = InstantWinMemberResponse;
      return this.apiClient.callApi(
        '/instant-wins/entrants-info', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getInstantWinLogs operation.
     * @callback module:api/InstantWinsApi~getInstantWinLogsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InstantWinLogResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    getInstantWinLogs(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = InstantWinLogResponse;
      return this.apiClient.callApi(
        '/instant-wins/logs', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getInstantWinStatistics operation.
     * @callback module:api/InstantWinsApi~getInstantWinStatisticsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InstantWinStatisticsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/InstantWinsApi~getInstantWinStatisticsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InstantWinStatisticsResponse}
     */
    getInstantWinStatistics(instantWinId, callback) {
      let postBody = null;
      // verify the required parameter 'instantWinId' is set
      if (instantWinId === undefined || instantWinId === null) {
        throw new Error("Missing the required parameter 'instantWinId' when calling getInstantWinStatistics");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = InstantWinStatisticsResponse;
      return this.apiClient.callApi(
        '/instant-wins/statistics', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
