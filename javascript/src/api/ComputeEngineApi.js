...
export default class ComputeEngineApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the updateComputeEnginesState operation.
     * @callback module:api/ComputeEngineApi~updateComputeEnginesStateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ApiResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/UpdateComputeEngineStateRequest>} opts.body Updates the state of the Competition
     * @param {module:api/ComputeEngineApi~updateComputeEnginesStateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApiResponse}
     */
    updateComputeEnginesState(opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
