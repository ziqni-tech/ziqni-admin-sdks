...
class Wallet {
     ...
     */
    constructor(id, spaceName, created, walletTypeId, balance) { 
        ModelDefault.initialize(this, id, spaceName, created);OptParamModels.initialize(this);WalletAllOf.initialize(this, walletTypeId, balance);
        Wallet.initialize(this, id, spaceName, created, walletTypeId, balance);
    }
     ...
     */
    static initialize(obj, id, spaceName, created, walletTypeId, balance) { 
        obj['id'] = id;
