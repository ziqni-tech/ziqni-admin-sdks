 ...
 * @member {String} icon
 */
CreateProductRequest.prototype['icon'] = undefined;

/**
 * Link to the banner
 * @member {String} banner
 */
CreateProductRequest.prototype['banner'] = undefined;

/**
 * Link to the bannerLowResolution
 * @member {String} bannerLowResolution
 */
CreateProductRequest.prototype['bannerLowResolution'] = undefined;

/**
 * Link to the bannerHighResolution
 * @member {String} bannerHighResolution
 */
CreateProductRequest.prototype['bannerHighResolution'] = undefined;
