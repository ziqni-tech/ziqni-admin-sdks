...
class RabbitMqConnection {
    ...
    constructor(id, spaceName, created, name, uri, virtualHost, port, userName, password, queueName, lastKnownStatus, lastKnownStatusCode, constraints, transformerId) { 
        ModelDefault.initialize(this, id, spaceName, created);OptParamModels.initialize(this);RabbitMqConnectionAllOf.initialize(this, name, uri, virtualHost, port, userName, password, queueName, lastKnownStatus, lastKnownStatusCode, constraints, transformerId);
