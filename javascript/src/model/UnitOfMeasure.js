 ...
 */
UnitOfMeasure.prototype['subUnit'] = undefined;

/**
 * The sub unit symbol of a unit of measure
 * @member {String} subUnitSymbol
 */
UnitOfMeasure.prototype['subUnitSymbol'] = undefined;

/**
 * The sub unit conversion
 * @member {Number} subUnitConversion
 */
UnitOfMeasure.prototype['subUnitConversion'] = undefined;
 ...
 * @member {String} subUnit
 */
UnitOfMeasureAllOf.prototype['subUnit'] = undefined;
/**
 * The sub unit symbol of a unit of measure
 * @member {String} subUnitSymbol
 */
UnitOfMeasureAllOf.prototype['subUnitSymbol'] = undefined;
/**
 * The sub unit conversion
 * @member {Number} subUnitConversion
 */
UnitOfMeasureAllOf.prototype['subUnitConversion'] = undefined;
/**
 * Is used to multiply the value from the standardised one that is being used
 * @member {Number} multiplier
 */
