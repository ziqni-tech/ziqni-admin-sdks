...
class MemberMessage {
     ...
     */
    constructor(id, spaceName, created, eventRefType, messageType, subject, body, status, expiry, links) { 
        ModelDefault.initialize(this, id, spaceName, created);OptParamModels.initialize(this);MemberMessageAllOf.initialize(this, eventRefType, messageType, subject, body, status, expiry, links);
        MemberMessage.initialize(this, id, spaceName, created, eventRefType, messageType, subject, body, status, expiry, links);
    }
     ...
     */
    static initialize(obj, id, spaceName, created, eventRefType, messageType, subject, body, status, expiry, links) { 
        obj['id'] = id;
 ...
 */
MemberMessage.prototype['links'] = undefined;

/**
 * 
 * @member {Array.<String>} memberIds
 */
MemberMessage.prototype['memberIds'] = undefined;
