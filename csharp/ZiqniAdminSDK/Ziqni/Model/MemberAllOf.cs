...
namespace Ziqni.Model
{
    ...
    public partial class MemberAllOf : IEquatable<MemberAllOf>, IValidatableObject
    {
        ...
        public MemberAllOf(string name = default(string), string memberRefId = default(string), MemberType memberType = default(MemberType), string icon = default(string), List<string> teamMembers = default(List<string>), List<string> constraints = default(List<string>), string timeZoneOffset = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for MemberAllOf and cannot be null");
            // to ensure "memberRefId" is required (not null)
            this.MemberRefId = memberRefId ?? throw new ArgumentNullException("memberRefId is a required property for MemberAllOf and cannot be null");
