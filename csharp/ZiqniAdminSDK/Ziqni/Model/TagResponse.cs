...
namespace Ziqni.Model
{
    ...
    public partial class TagResponse : IEquatable<TagResponse>, IValidatableObject
    {
        ...
        public TagResponse(MetaExtended meta = default(MetaExtended), List<Tag> results = default(List<Tag>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for TagResponse and cannot be null");
