...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateNotificationRequest_allOf")]
    public partial class CreateNotificationRequestAllOf : IEquatable<CreateNotificationRequestAllOf>, IValidatableObject
    {
        ...
        public CreateNotificationRequestAllOf(MessageType messageType = default(MessageType), string subject = default(string), string body = default(string), MessageStatus status = default(MessageStatus), List<Translation> translations = default(List<Translation>), Scheduling scheduling = default(Scheduling), List<string> constraints = default(List<string>), List<string> memberTags = default(List<string>), List<string> memberIds = default(List<string>), DateTime expireAfterDate = default(DateTime), int expireAfterDays = default(int))
        {
            ...
            this.Subject = subject ?? throw new ArgumentNullException("subject is a required property for CreateNotificationRequestAllOf and cannot be null");
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for CreateNotificationRequestAllOf and cannot be null");
            this.Status = status;
            // to ensure "scheduling" is required (not null)
            this.Scheduling = scheduling ?? throw new ArgumentNullException("scheduling is a required property for CreateNotificationRequestAllOf and cannot be null");
            // to ensure "constraints" is required (not null)
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for CreateNotificationRequestAllOf and cannot be null");
