...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCompetitionRequest")]
    public partial class UpdateCompetitionRequest : IEquatable<UpdateCompetitionRequest>, IValidatableObject
    {
        ...
        public UpdateCompetitionRequest(string id = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), CompetitionType? competitionType = default(CompetitionType?), int numberOfRounds = default(int), int numberOfGroupStages = default(int), string name = default(string), string description = default(string), string termsAndConditions = default(string), string entrantMemberType = default(string), int maxNumberOfEntrants = default(int), int minNumberOfEntrants = default(int), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), List<string> constraints = default(List<string>), List<string> addConstraints = default(List<string>), List<string> removeConstraints = default(List<string>), List<string> productIds = default(List<string>), CreateContestForCompetitionRequest createContests = default(CreateContestForCompetitionRequest), UpdateContestRequest updateContests = default(UpdateContestRequest), DependantOn entrantMemberTagsFilter = default(DependantOn), DependantOn productTagsFilter = default(DependantOn), string icon = default(string), string banner = default(string), string bannerLowResolution = default(string), string bannerHighResolution = default(string))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpdateCompetitionRequest and cannot be null");
