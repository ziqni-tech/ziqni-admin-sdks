...
namespace Ziqni.Model
{
    ...
    /// SpaceTokenRequest
    /// </summary>
    [DataContract(Name = "SpaceTokenRequest")]
    public partial class SpaceTokenRequest : IEquatable<SpaceTokenRequest>, IValidatableObject
    {
        ...
        public SpaceTokenRequest(string userToken = default(string), string spaceName = default(string))
        {
            ...
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for SpaceTokenRequest and cannot be null");
