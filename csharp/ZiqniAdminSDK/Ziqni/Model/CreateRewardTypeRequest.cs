...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateRewardTypeRequest")]
    public partial class CreateRewardTypeRequest : IEquatable<CreateRewardTypeRequest>, IValidatableObject
    {
        ...
        public CreateRewardTypeRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string description = default(string), string key = default(string), List<Translation> translations = default(List<Translation>), List<string> addConstraints = default(List<string>), string unitOfMeasure = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateRewardTypeRequest and cannot be null");
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for CreateRewardTypeRequest and cannot be null");
            // to ensure "unitOfMeasure" is required (not null)
            this.UnitOfMeasure = unitOfMeasure ?? throw new ArgumentNullException("unitOfMeasure is a required property for CreateRewardTypeRequest and cannot be null");
