...
namespace Ziqni.Model
{
    ...
    public partial class UserResponse : IEquatable<UserResponse>, IValidatableObject
    {
        ...
        public UserResponse(MetaExtended meta = default(MetaExtended), List<User> results = default(List<User>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for UserResponse and cannot be null");
