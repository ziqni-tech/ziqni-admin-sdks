...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateContestForCompetitionRequest_allOf")]
    public partial class CreateContestForCompetitionRequestAllOf : IEquatable<CreateContestForCompetitionRequestAllOf>, IValidatableObject
    {
        ...
        public CreateContestForCompetitionRequestAllOf(string competitionId = default(string), int row = default(int), int round = default(int), int groupStage = default(int), string groupStageLabel = default(string), List<string> entrantsFromContest = default(List<string>), string name = default(string), string description = default(string), string termsAndConditions = default(string), RoundType roundType = default(RoundType), int maxNumberOfEntrants = default(int), int minNumberOfEntrants = default(int), List<Rule> rules = default(List<Rule>), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), TournamentStrategies strategies = default(TournamentStrategies), List<Translation> translations = default(List<Translation>), List<CreateRewardRequest> rewards = default(List<CreateRewardRequest>), string icon = default(string), string banner = default(string), string bannerLowResolution = default(string), string bannerHighResolution = default(string), List<string> constraints = default(List<string>))
        {
            ...
            this.CompetitionId = competitionId ?? throw new ArgumentNullException("competitionId is a required property for CreateContestForCompetitionRequestAllOf and cannot be null");
            this.Row = row;
            this.Round = round;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateContestForCompetitionRequestAllOf and cannot be null");
            this.RoundType = roundType;
            this.MinNumberOfEntrants = minNumberOfEntrants;
            this.ScheduledStartDate = scheduledStartDate;
            this.ScheduledEndDate = scheduledEndDate;
            // to ensure "strategies" is required (not null)
            this.Strategies = strategies ?? throw new ArgumentNullException("strategies is a required property for CreateContestForCompetitionRequestAllOf and cannot be null");
            // to ensure "constraints" is required (not null)
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for CreateContestForCompetitionRequestAllOf and cannot be null");
