...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCompetitionRequest")]
    public partial class CreateCompetitionRequest : IEquatable<CreateCompetitionRequest>, IValidatableObject
    {
        ...
        public CreateCompetitionRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), CompetitionType competitionType = default(CompetitionType), int numberOfRounds = default(int), int numberOfGroupStages = default(int), string name = default(string), string description = default(string), string termsAndConditions = default(string), string entrantMemberType = default(string), int maxNumberOfEntrants = default(int), int minNumberOfEntrants = default(int), List<Rule> rules = default(List<Rule>), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), List<Translation> translations = default(List<Translation>), CreateContestRequest contests = default(CreateContestRequest), List<CreateRewardRequest> rewards = default(List<CreateRewardRequest>), List<string> constraints = default(List<string>), List<string> addConstraints = default(List<string>), List<string> productIds = default(List<string>), DependantOn entrantMemberTagsFilter = default(DependantOn), DependantOn productTagsFilter = default(DependantOn), string icon = default(string), string banner = default(string), string bannerLowResolution = default(string), string bannerHighResolution = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateCompetitionRequest and cannot be null");
            this.MinNumberOfEntrants = minNumberOfEntrants;
            this.ScheduledStartDate = scheduledStartDate;
            this.ScheduledEndDate = scheduledEndDate;
            // to ensure "constraints" is required (not null)
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for CreateCompetitionRequest and cannot be null");
            // to ensure "productIds" is required (not null)
            this.ProductIds = productIds ?? throw new ArgumentNullException("productIds is a required property for CreateCompetitionRequest and cannot be null");
