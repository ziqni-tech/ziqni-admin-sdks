...
namespace Ziqni.Model
{
    ...
    public partial class RewardResponse : IEquatable<RewardResponse>, IValidatableObject
    {
        ...
        public RewardResponse(MetaExtended meta = default(MetaExtended), List<Reward> results = default(List<Reward>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for RewardResponse and cannot be null");
        ...
        public List<Reward> Results { get; set; }
