...
namespace Ziqni.Model
{
    ...
    /// MemberTokenRequest
    /// </summary>
    [DataContract(Name = "MemberTokenRequest")]
    public partial class MemberTokenRequest : IEquatable<MemberTokenRequest>, IValidatableObject
    {
        ...
        public MemberTokenRequest(string apiKey = default(string), bool isReferenceId = default(bool), List<string> origins = default(List<string>), string member = default(string), int expires = default(int), string resource = default(string), List<string> disabledServices = default(List<string>), string languageKey = default(string), string currencyKey = default(string), int timeZoneOffset = default(int))
        {
            ...
            this.ApiKey = apiKey ?? throw new ArgumentNullException("apiKey is a required property for MemberTokenRequest and cannot be null");
            // to ensure "member" is required (not null)
            this.Member = member ?? throw new ArgumentNullException("member is a required property for MemberTokenRequest and cannot be null");
            // to ensure "resource" is required (not null)
            this.Resource = resource ?? throw new ArgumentNullException("resource is a required property for MemberTokenRequest and cannot be null");
        ...
        [DataMember(Name = "isReferenceId", EmitDefaultValue = true)]
