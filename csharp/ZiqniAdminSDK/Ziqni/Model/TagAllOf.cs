...
namespace Ziqni.Model
{
    ...
    /// TagAllOf
    /// </summary>
    [DataContract(Name = "Tag_allOf")]
    public partial class TagAllOf : IEquatable<TagAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagAllOf" /> class.
        /// </summary>
        ...
        public TagAllOf(string name = default(string), string key = default(string), string description = default(string), List<string> entityTypes = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for TagAllOf and cannot be null");
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for TagAllOf and cannot be null");
        ...
        {
            return this.Equals(input as TagAllOf);
        }

        /// <summary>
        /// Returns true if TagAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TagAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagAllOf input)
        {
            if (input == null)
                return false;
