...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateFileObjectRequest")]
    public partial class CreateFileObjectRequest : IEquatable<CreateFileObjectRequest>, IValidatableObject
    {
        ...
        public CreateFileObjectRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string repositoryId = default(string), string name = default(string), string mimeType = default(string), string parentFolderPath = default(string), List<string> constraints = default(List<string>))
        {
            ...
            this.RepositoryId = repositoryId ?? throw new ArgumentNullException("repositoryId is a required property for CreateFileObjectRequest and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateFileObjectRequest and cannot be null");
            // to ensure "mimeType" is required (not null)
            this.MimeType = mimeType ?? throw new ArgumentNullException("mimeType is a required property for CreateFileObjectRequest and cannot be null");
            // to ensure "parentFolderPath" is required (not null)
            this.ParentFolderPath = parentFolderPath ?? throw new ArgumentNullException("parentFolderPath is a required property for CreateFileObjectRequest and cannot be null");
