...
namespace Ziqni.Model
{
    ...
    public partial class RuleResponse : IEquatable<RuleResponse>, IValidatableObject
    {
        ...
        public RuleResponse(MetaExtended meta = default(MetaExtended), List<Rule> results = default(List<Rule>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for RuleResponse and cannot be null");
