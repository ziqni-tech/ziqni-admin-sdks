...
namespace Ziqni.Model
{
    ...
    /// ComputeEngine
    /// </summary>
    [DataContract(Name = "ComputeEngine")]
    public partial class ComputeEngine : IEquatable<ComputeEngine>, IValidatableObject
    {
        ...
        public ComputeEngine(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string description = default(string), long version = default(long), string name = default(string), long uptime = default(long), List<string> constraints = default(List<string>), Dictionary<string, string> statistics = default(Dictionary<string, string>), int lastKnownStatusCode = default(int))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ComputeEngine and cannot be null");
            // to ensure "spaceName" is required (not null)
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for ComputeEngine and cannot be null");
            this.Created = created;
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for ComputeEngine and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ComputeEngine and cannot be null");
