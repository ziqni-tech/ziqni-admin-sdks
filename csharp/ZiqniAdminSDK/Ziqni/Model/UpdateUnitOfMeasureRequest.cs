...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateUnitOfMeasureRequest")]
    public partial class UpdateUnitOfMeasureRequest : IEquatable<UpdateUnitOfMeasureRequest>, IValidatableObject
    {
        ...
        public UpdateUnitOfMeasureRequest(string id = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string description = default(string), string isoCode = default(string), string symbol = default(string), double multiplier = default(double), UnitOfMeasureType? unitOfMeasureType = default(UnitOfMeasureType?))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpdateUnitOfMeasureRequest and cannot be null");
