...
namespace Ziqni.Model
{
    ...
    public partial class Event : IEquatable<Event>, IValidatableObject
    {
        ...
        public Event(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), string memberId = default(string), string memberRefId = default(string), string action = default(string), string batchId = default(string), string entityId = default(string), string eventRefId = default(string), string entityRefId = default(string), double sourceValue = default(double), double points = default(double), DateTime transactionTimestamp = default(DateTime), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), List<string> relatesTo = default(List<string>), List<string> relatesToExternal = default(List<string>), string unitOfMeasure = default(string))
        {
            ...
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for Event and cannot be null");
            this.Created = created;
            // to ensure "action" is required (not null)
            this.Action = action ?? throw new ArgumentNullException("action is a required property for Event and cannot be null");
