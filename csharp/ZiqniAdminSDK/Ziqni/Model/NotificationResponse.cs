...
namespace Ziqni.Model
{
    ...
    public partial class NotificationResponse : IEquatable<NotificationResponse>, IValidatableObject
    {
        ...
        public NotificationResponse(MetaExtended meta = default(MetaExtended), List<Notification> results = default(List<Notification>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for NotificationResponse and cannot be null");
