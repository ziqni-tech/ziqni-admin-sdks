...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateInstantWinRequest")]
    public partial class CreateInstantWinRequest : IEquatable<CreateInstantWinRequest>, IValidatableObject
    {
        ...
        public CreateInstantWinRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string description = default(string), string termsAndConditions = default(string), List<string> constraints = default(List<string>), int statusCode = default(int), int instantWinType = default(int), List<CreateInstantWinTile> tiles = default(List<CreateInstantWinTile>), List<Translation> translations = default(List<Translation>))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateInstantWinRequest and cannot be null");
