...
namespace Ziqni.Model
{
    ...
    public partial class CustomFieldResponse : IEquatable<CustomFieldResponse>, IValidatableObject
    {
        ...
        public CustomFieldResponse(MetaExtended meta = default(MetaExtended), List<CustomField> results = default(List<CustomField>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for CustomFieldResponse and cannot be null");
