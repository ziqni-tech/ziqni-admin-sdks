...
namespace Ziqni.Model
{
    ...
    /// ContestReducedAllOf
    /// </summary>
    [DataContract(Name = "ContestReduced_allOf")]
    public partial class ContestReducedAllOf : IEquatable<ContestReducedAllOf>, IValidatableObject
    {
        ...
        public ContestReducedAllOf(string competitionId = default(string), int row = default(int), string name = default(string), int round = default(int), int groupStage = default(int), List<string> entrantsFromContest = default(List<string>), ContestStatus status = default(ContestStatus), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), List<string> tags = default(List<string>), List<RewardReduced> rewards = default(List<RewardReduced>))
        {
            ...
            this.CompetitionId = competitionId ?? throw new ArgumentNullException("competitionId is a required property for ContestReducedAllOf and cannot be null");
            this.Row = row;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ContestReducedAllOf and cannot be null");
            this.Round = round;
            this.GroupStage = groupStage;
            // to ensure "entrantsFromContest" is required (not null)
            this.EntrantsFromContest = entrantsFromContest ?? throw new ArgumentNullException("entrantsFromContest is a required property for ContestReducedAllOf and cannot be null");
            this.Status = status;
