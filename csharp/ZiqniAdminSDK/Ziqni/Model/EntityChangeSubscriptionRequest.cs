...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityChangeSubscriptionRequest")]
    public partial class EntityChangeSubscriptionRequest : IEquatable<EntityChangeSubscriptionRequest>, IValidatableObject
    {
        ...
        public EntityChangeSubscriptionRequest(string entityType = default(string), List<string> constraints = default(List<string>), string callback = default(string), ActionEnum action = default(ActionEnum))
        {
            ...
            this.EntityType = entityType ?? throw new ArgumentNullException("entityType is a required property for EntityChangeSubscriptionRequest and cannot be null");
            // to ensure "callback" is required (not null)
            this.Callback = callback ?? throw new ArgumentNullException("callback is a required property for EntityChangeSubscriptionRequest and cannot be null");
            this.Action = action;
