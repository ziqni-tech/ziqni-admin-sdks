...
namespace Ziqni.Model
{
    ...
    public partial class ApiResponse : IEquatable<ApiResponse>, IValidatableObject
    {
        ...
        public ApiResponse(MetaBasic meta = default(MetaBasic), List<Result> results = default(List<Result>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for ApiResponse and cannot be null");
