...
namespace Ziqni.Model
{
    ...
    public partial class Collaborator : IEquatable<Collaborator>, IValidatableObject
    {
        ...
        public Collaborator(string email = default(string), List<string> roles = default(List<string>), string lastName = default(string), string firstName = default(string), CollaboratorRolesAvailable availableRoles = default(CollaboratorRolesAvailable), string id = default(string), string spaceName = default(string))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for Collaborator and cannot be null");
            this.Roles = roles;
