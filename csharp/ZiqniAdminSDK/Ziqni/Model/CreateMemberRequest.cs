...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateMemberRequest")]
    public partial class CreateMemberRequest : IEquatable<CreateMemberRequest>, IValidatableObject
    {
        ...
        public CreateMemberRequest(string name = default(string), string memberRefId = default(string), MemberType memberType = default(MemberType), string icon = default(string), List<string> teamMembers = default(List<string>), List<string> addConstraints = default(List<string>), string timeZoneOffset = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateMemberRequest and cannot be null");
            // to ensure "memberRefId" is required (not null)
            this.MemberRefId = memberRefId ?? throw new ArgumentNullException("memberRefId is a required property for CreateMemberRequest and cannot be null");
