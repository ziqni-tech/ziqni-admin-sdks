...
namespace Ziqni.Model
{
    ...
    public partial class Transformer : IEquatable<Transformer>, IValidatableObject
    {
        ...
        public Transformer(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), string name = default(string), string source = default(string), SourceLanguage sourceLanguage = default(SourceLanguage))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Transformer and cannot be null");
            // to ensure "spaceName" is required (not null)
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for Transformer and cannot be null");
            this.Created = created;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Transformer and cannot be null");
            // to ensure "source" is required (not null)
            this.Source = source ?? throw new ArgumentNullException("source is a required property for Transformer and cannot be null");
