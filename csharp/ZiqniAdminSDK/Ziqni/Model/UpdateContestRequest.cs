...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateContestRequest")]
    public partial class UpdateContestRequest : IEquatable<UpdateContestRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateContestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateContestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateContestRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateContestRequest);
        }

        /// <summary>
        /// Returns true if UpdateContestRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateContestRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateContestRequest input)
        {
            if (input == null)
                return false;
