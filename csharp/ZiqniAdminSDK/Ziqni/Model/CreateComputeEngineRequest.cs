...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateComputeEngineRequest")]
    public partial class CreateComputeEngineRequest : IEquatable<CreateComputeEngineRequest>, IValidatableObject
    {
        ...
        public CreateComputeEngineRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string description = default(string), long version = default(long), string name = default(string), long uptime = default(long), List<string> constraints = default(List<string>), Dictionary<string, string> statistics = default(Dictionary<string, string>), int lastKnownStatusCode = default(int))
        {
            ...
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for CreateComputeEngineRequest and cannot be null");
