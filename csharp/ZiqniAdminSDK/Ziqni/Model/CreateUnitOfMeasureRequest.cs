...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateUnitOfMeasureRequest")]
    public partial class CreateUnitOfMeasureRequest : IEquatable<CreateUnitOfMeasureRequest>, IValidatableObject
    {
        ...
        public CreateUnitOfMeasureRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string key = default(string), string description = default(string), string isoCode = default(string), string symbol = default(string), double multiplier = default(double), UnitOfMeasureType unitOfMeasureType = default(UnitOfMeasureType))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateUnitOfMeasureRequest and cannot be null");
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for CreateUnitOfMeasureRequest and cannot be null");
