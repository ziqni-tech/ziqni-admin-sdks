...
namespace Ziqni.Model
{
    ...
    public partial class Repository : IEquatable<Repository>, IValidatableObject
    {
        ...
        public Repository(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string description = default(string), List<string> constraints = default(List<string>), HostingOptions hostingOptions = default(HostingOptions))
        {
            ...
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for Repository and cannot be null");
            ...
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for Repository and cannot be null");
            // to ensure "hostingOptions" is required (not null)
            this.HostingOptions = hostingOptions ?? throw new ArgumentNullException("hostingOptions is a required property for Repository and cannot be null");
