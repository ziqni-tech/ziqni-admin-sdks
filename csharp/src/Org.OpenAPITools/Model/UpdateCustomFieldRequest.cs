...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UpdateCustomFieldRequest :  IEquatable<UpdateCustomFieldRequest>, IValidatableObject
    {
        ...
        public UpdateCustomFieldRequest(string id = default(string), string name = default(string), string description = default(string), FieldType? fieldType = default(FieldType?), AppliesTo? appliesTo = default(AppliesTo?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for UpdateCustomFieldRequest and cannot be null");
            }
            else
            {
                this.Id = id;
