...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateNotificationRequestAllOf :  IEquatable<CreateNotificationRequestAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNotificationRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateNotificationRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNotificationRequestAllOf" /> class.
        /// </summary>
        ...
        public CreateNotificationRequestAllOf(MessageType messageType = default(MessageType), string subject = default(string), string body = default(string), MessageStatus status = default(MessageStatus), List<Translation> translations = default(List<Translation>), Scheduling scheduling = default(Scheduling), List<string> constraints = default(List<string>), List<string> memberTags = default(List<string>), List<string> memberIds = default(List<string>), DateTime expireAfterDate = default(DateTime), int expireAfterDays = default(int))
        {
            ...
            if (subject == null)
            {
                throw new InvalidDataException("subject is a required property for CreateNotificationRequestAllOf and cannot be null");
            }
            else
            {
            ...
            if (body == null)
            {
                throw new InvalidDataException("body is a required property for CreateNotificationRequestAllOf and cannot be null");
            }
            else
            {
                this.Body = body;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for CreateNotificationRequestAllOf and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (scheduling == null)
            {
                throw new InvalidDataException("scheduling is a required property for CreateNotificationRequestAllOf and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for CreateNotificationRequestAllOf and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateNotificationRequestAllOf);
        }

        /// <summary>
        /// Returns true if CreateNotificationRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateNotificationRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateNotificationRequestAllOf input)
        {
            if (input == null)
                return false;
