...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        public User(string objectType = default(string), string firstName = default(string), string lastName = default(string), string email = default(string), List<string> constraints = default(List<string>), List<string> spaces = default(List<string>))
        {
            ...
            if (objectType == null)
            {
                throw new InvalidDataException("objectType is a required property for User and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for User and cannot be null");
            }
            else
            {
