...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MemberAwardAllOf :  IEquatable<MemberAwardAllOf>, IValidatableObject
    {
        ...
        public MemberAwardAllOf(string rewardId = default(string), string rewardType = default(string), string rewardTypeId = default(string), double rewardValue = default(double), int delay = default(int), EntityType entityType = default(EntityType), string entityId = default(string), DateTime pointInTime = default(DateTime), int period = default(int), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), List<string> constraints = default(List<string>), DateTime claimedTimestamp = default(DateTime))
        {
            ...
            if (rewardId == null)
            {
                throw new InvalidDataException("rewardId is a required property for MemberAwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (rewardType == null)
            {
                throw new InvalidDataException("rewardType is a required property for MemberAwardAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("rewardTypeId is a required property for MemberAwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (rewardValue == null)
            {
                throw new InvalidDataException("rewardValue is a required property for MemberAwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (entityType == null)
            {
                throw new InvalidDataException("entityType is a required property for MemberAwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (entityId == null)
            {
                throw new InvalidDataException("entityId is a required property for MemberAwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for MemberAwardAllOf and cannot be null");
            }
            else
            {
