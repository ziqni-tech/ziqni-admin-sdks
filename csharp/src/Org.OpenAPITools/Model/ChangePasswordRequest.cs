...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ChangePasswordRequest :  IEquatable<ChangePasswordRequest>, IValidatableObject
    {
        ...
        public ChangePasswordRequest(string email = default(string), string password = default(string), string newPassword = default(string), string confirmPassword = default(string), string twoFactorAccessCode = default(string))
        {
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for ChangePasswordRequest and cannot be null");
            }
            else
            {
                this.Email = email;
            ...
            if (password == null)
            {
                throw new InvalidDataException("password is a required property for ChangePasswordRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("confirmPassword is a required property for ChangePasswordRequest and cannot be null");
            }
            else
            {
