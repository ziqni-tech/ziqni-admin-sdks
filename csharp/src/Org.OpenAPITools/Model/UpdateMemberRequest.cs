...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UpdateMemberRequest :  IEquatable<UpdateMemberRequest>, IValidatableObject
    {
        ...
        public UpdateMemberRequest(string id = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), MemberType? memberType = default(MemberType?), List<string> teamMembers = default(List<string>), List<string> addConstraints = default(List<string>), List<string> removeConstraints = default(List<string>), string timeZoneOffset = default(string))
        {
