...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UpdateAchievementRequestAllOf :  IEquatable<UpdateAchievementRequestAllOf>, IValidatableObject
    {
        ...
        public UpdateAchievementRequestAllOf(string name = default(string), string description = default(string), string termsAndConditions = default(string), string icon = default(string), Scheduling scheduling = default(Scheduling), AchievementLiveStatus? achievementLiveStatus = default(AchievementLiveStatus?), int maxNumberOfIssues = default(int), List<string> constraints = default(List<string>), DependantOn achievementDependencies = default(DependantOn), DependantOn memberTagsFilter = default(DependantOn), DependantOn productTagsFilter = default(DependantOn), List<string> addConstraints = default(List<string>), List<string> removeConstraints = default(List<string>))
        {
            this.Name = name;
