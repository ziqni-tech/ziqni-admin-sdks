...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateContestForCompetitionRequest :  IEquatable<CreateContestForCompetitionRequest>, IValidatableObject
    {
        ...
        public CreateContestForCompetitionRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string competitionId = default(string), int row = default(int), int round = default(int), int groupStage = default(int), string groupStageLabel = default(string), List<string> entrantsFromContest = default(List<string>), string name = default(string), string description = default(string), string termsAndConditions = default(string), RoundType roundType = default(RoundType), int maxNumberOfEntrants = default(int), int minNumberOfEntrants = default(int), List<Rule> rules = default(List<Rule>), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), Strategy strategies = default(Strategy), List<Translation> translations = default(List<Translation>), List<CreateRewardRequest> rewards = default(List<CreateRewardRequest>), List<string> constraints = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("competitionId is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
            ...
            if (row == null)
            {
                throw new InvalidDataException("row is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
                this.Row = row;
            ...
            if (round == null)
            {
                throw new InvalidDataException("round is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
                this.Round = round;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (roundType == null)
            {
                throw new InvalidDataException("roundType is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("minNumberOfEntrants is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledStartDate is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledEndDate is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
            ...
            if (strategies == null)
            {
                throw new InvalidDataException("strategies is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for CreateContestForCompetitionRequest and cannot be null");
            }
            else
            {
