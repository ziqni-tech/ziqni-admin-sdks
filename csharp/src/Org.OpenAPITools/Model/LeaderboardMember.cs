...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LeaderboardMember :  IEquatable<LeaderboardMember>, IValidatableObject
    {
        ...
        public LeaderboardMember(string name = default(string), string memberId = default(string), string memberRefId = default(string), int rankChangeFrom = default(int), int rankChangeType = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for LeaderboardMember and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (memberId == null)
            {
                throw new InvalidDataException("memberId is a required property for LeaderboardMember and cannot be null");
            }
            else
            {
            ...
            if (memberRefId == null)
            {
                throw new InvalidDataException("memberRefId is a required property for LeaderboardMember and cannot be null");
            }
            else
            {
