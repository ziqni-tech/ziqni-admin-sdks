...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FileObjectAllOf :  IEquatable<FileObjectAllOf>, IValidatableObject
    {
        ...
        public FileObjectAllOf(string repositoryId = default(string), string name = default(string), string mimeType = default(string), string path = default(string), string parentFolderPath = default(string), string uri = default(string), long size = default(long), List<string> constraints = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("repositoryId is a required property for FileObjectAllOf and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FileObjectAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (mimeType == null)
            {
                throw new InvalidDataException("mimeType is a required property for FileObjectAllOf and cannot be null");
            }
            else
            {
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for FileObjectAllOf and cannot be null");
            }
            else
            {
                this.Path = path;
            ...
            {
                throw new InvalidDataException("parentFolderPath is a required property for FileObjectAllOf and cannot be null");
            }
            else
            {
