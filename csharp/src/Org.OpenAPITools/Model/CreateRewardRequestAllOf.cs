...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateRewardRequestAllOf :  IEquatable<CreateRewardRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRewardRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateRewardRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRewardRequestAllOf" /> class.
        /// </summary>
        ...
        public CreateRewardRequestAllOf(string name = default(string), string description = default(string), string rewardRank = default(string), double rewardValue = default(double), string icon = default(string), int issueLimit = default(int), int delay = default(int), DateTime pointInTime = default(DateTime), int period = default(int), List<Translation> translations = default(List<Translation>), List<string> addConstraints = default(List<string>), string rewardTypeId = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateRewardRequestAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (rewardRank == null)
            {
                throw new InvalidDataException("rewardRank is a required property for CreateRewardRequestAllOf and cannot be null");
            }
            else
            {
            ...
            if (rewardValue == null)
            {
                throw new InvalidDataException("rewardValue is a required property for CreateRewardRequestAllOf and cannot be null");
            }
            else
            {
            ...
            if (delay == null)
            {
                throw new InvalidDataException("delay is a required property for CreateRewardRequestAllOf and cannot be null");
            }
            else
            {
                this.Delay = delay;
            ...
            {
                throw new InvalidDataException("rewardTypeId is a required property for CreateRewardRequestAllOf and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateRewardRequestAllOf);
        }

        /// <summary>
        /// Returns true if CreateRewardRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateRewardRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateRewardRequestAllOf input)
        {
            if (input == null)
                return false;
