...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateAchievementRequest :  IEquatable<CreateAchievementRequest>, IValidatableObject
    {
        ...
        public CreateAchievementRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string description = default(string), string termsAndConditions = default(string), string icon = default(string), List<Rule> rules = default(List<Rule>), Scheduling scheduling = default(Scheduling), int maxNumberOfIssues = default(int), List<Translation> translations = default(List<Translation>), List<CreateRewardRequest> rewards = default(List<CreateRewardRequest>), List<string> constraints = default(List<string>), DependantOn achievementDependencies = default(DependantOn), DependantOn memberTagsFilter = default(DependantOn), DependantOn productTagsFilter = default(DependantOn), List<string> addConstraints = default(List<string>))
        {
            ...
            if (scheduling == null)
            {
                throw new InvalidDataException("scheduling is a required property for CreateAchievementRequest and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for CreateAchievementRequest and cannot be null");
            }
            else
            {
