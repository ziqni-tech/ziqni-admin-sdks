...
namespace Ziqni.Model
{
    ...
    /// TranslatedField
    /// </summary>
    [DataContract(Name = "TranslatedField")]
    public partial class TranslatedField : IEquatable<TranslatedField>, IValidatableObject
    {
        ...
        public TranslatedField(string fieldName = default(string), string text = default(string))
        {
            ...
            this.FieldName = fieldName ?? throw new ArgumentNullException("fieldName is a required property for TranslatedField and cannot be null");
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text is a required property for TranslatedField and cannot be null");
        }
