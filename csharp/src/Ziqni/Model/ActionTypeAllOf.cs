...
namespace Ziqni.Model
{
    ...
    public partial class ActionTypeAllOf :  IEquatable<ActionTypeAllOf>, IValidatableObject
    {
        ...
        public ActionTypeAllOf(string name = default(string), string key = default(string), string description = default(string), List<string> constraints = default(List<string>), string unitOfMeasure = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ActionTypeAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for ActionTypeAllOf and cannot be null");
            }
            else
            {
                this.Key = key;
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for ActionTypeAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("unitOfMeasure is a required property for ActionTypeAllOf and cannot be null");
            }
            else
            {
