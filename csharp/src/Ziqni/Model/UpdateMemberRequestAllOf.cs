...
namespace Ziqni
{
    ...
    public partial class UpdateMemberRequestAllOf :  IEquatable<UpdateMemberRequestAllOf>, IValidatableObject
    {
        ...
        public UpdateMemberRequestAllOf(string name = default(string), MemberType? memberType = default(MemberType?), List<string> teamMembers = default(List<string>), List<string> addConstraints = default(List<string>), List<string> removeConstraints = default(List<string>), string timeZoneOffset = default(string))
        {
            this.Name = name;
