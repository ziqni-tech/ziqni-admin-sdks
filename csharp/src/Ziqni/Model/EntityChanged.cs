...
namespace Ziqni.Model
{
    ...
    /// EntityChanged
    /// </summary>
    [DataContract(Name = "EntityChanged")]
    public partial class EntityChanged : IEquatable<EntityChanged>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityChanged" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EntityChanged);
        }

        /// <summary>
        /// Returns true if EntityChanged instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityChanged to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityChanged input)
        {
            if (input == null)
                return false;
