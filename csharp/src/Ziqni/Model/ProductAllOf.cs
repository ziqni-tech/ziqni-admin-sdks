...
namespace Ziqni
{
    ...
    public partial class ProductAllOf :  IEquatable<ProductAllOf>, IValidatableObject
    {
        ...
        public ProductAllOf(string name = default(string), string description = default(string), double adjustmentFactor = default(double), string productRefId = default(string), List<ActionTypeAdjustmentFactor> actionTypeAdjustmentFactors = default(List<ActionTypeAdjustmentFactor>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ProductAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("adjustmentFactor is a required property for ProductAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("productRefId is a required property for ProductAllOf and cannot be null");
            }
            else
            {
