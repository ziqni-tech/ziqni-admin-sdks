...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateActionTypeRequest_allOf")]
    public partial class UpdateActionTypeRequestAllOf : IEquatable<UpdateActionTypeRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateActionTypeRequestAllOf" /> class.
        /// </summary>
        ...
        public UpdateActionTypeRequestAllOf(string name = default(string), string description = default(string), List<string> addConstraints = default(List<string>), List<string> removeConstraints = default(List<string>), string unitOfMeasure = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateActionTypeRequestAllOf);
        }

        /// <summary>
        /// Returns true if UpdateActionTypeRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateActionTypeRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateActionTypeRequestAllOf input)
        {
            if (input == null)
                return false;
