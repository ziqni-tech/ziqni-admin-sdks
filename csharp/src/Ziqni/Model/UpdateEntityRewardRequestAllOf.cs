...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateEntityRewardRequest_allOf")]
    public partial class UpdateEntityRewardRequestAllOf : IEquatable<UpdateEntityRewardRequestAllOf>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEntityRewardRequestAllOf" /> class.
        /// </summary>
        ...
        public UpdateEntityRewardRequestAllOf(RewardEntityType? entityType = default(RewardEntityType?), string entityId = default(string), string name = default(string), string description = default(string), string rewardRank = default(string), double rewardValue = default(double), string icon = default(string), int issueLimit = default(int), int delay = default(int), DateTime pointInTime = default(DateTime), int period = default(int), List<Translation> translations = default(List<Translation>), List<string> addConstraints = default(List<string>), List<string> removeConstraints = default(List<string>), string rewardTypeId = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateEntityRewardRequestAllOf);
        }

        /// <summary>
        /// Returns true if UpdateEntityRewardRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEntityRewardRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEntityRewardRequestAllOf input)
        {
            if (input == null)
                return false;
