...
namespace Ziqni
{
    ...
    public partial class Reward :  IEquatable<Reward>, IValidatableObject
    {
        ...
        public Reward(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), EntityType? entityType = default(EntityType?), string entityId = default(string), string name = default(string), string description = default(string), string rewardRank = default(string), double rewardValue = default(double), RewardTypeReduced rewardType = default(RewardTypeReduced), string icon = default(string), int issueLimit = default(int), int delay = default(int), DateTime pointInTime = default(DateTime), int period = default(int), List<string> constraints = default(List<string>))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Reward and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (spaceName == null)
            {
                throw new InvalidDataException("spaceName is a required property for Reward and cannot be null");
            }
            else
            {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for Reward and cannot be null");
            }
            else
            {
            ...
            if (rewardRank == null)
            {
                throw new InvalidDataException("rewardRank is a required property for Reward and cannot be null");
            }
            else
            {
            ...
            if (rewardValue == null)
            {
                throw new InvalidDataException("rewardValue is a required property for Reward and cannot be null");
            }
            else
            {
            ...
            if (rewardType == null)
            {
                throw new InvalidDataException("rewardType is a required property for Reward and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for Reward and cannot be null");
            }
            else
            {
