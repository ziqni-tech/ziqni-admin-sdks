...
namespace Ziqni.Model
{
    ...
    public partial class Location :  IEquatable<Location>, IValidatableObject
    {
        ...
        public Location(double lat = default(double), double lon = default(double))
        {
            ...
            if (lat == null)
            {
                throw new InvalidDataException("lat is a required property for Location and cannot be null");
            }
            else
            {
                this.Lat = lat;
            ...
            if (lon == null)
            {
                throw new InvalidDataException("lon is a required property for Location and cannot be null");
            }
            else
            {
                this.Lon = lon;
