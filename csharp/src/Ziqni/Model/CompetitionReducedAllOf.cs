...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CompetitionReduced_allOf")]
    public partial class CompetitionReducedAllOf : IEquatable<CompetitionReducedAllOf>, IValidatableObject
    {
        ...
        public CompetitionReducedAllOf(CompetitionType competitionType = default(CompetitionType), int numberOfRounds = default(int), string name = default(string), CompetitionStatus status = default(CompetitionStatus), List<Dependancy> dependantOn = default(List<Dependancy>), string entrantMemberType = default(string), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), List<string> tags = default(List<string>), List<string> constraints = default(List<string>))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CompetitionReducedAllOf and cannot be null");
            this.Status = status;
            // to ensure "dependantOn" is required (not null)
            this.DependantOn = dependantOn ?? throw new ArgumentNullException("dependantOn is a required property for CompetitionReducedAllOf and cannot be null");
            this.ScheduledStartDate = scheduledStartDate;
            this.ScheduledEndDate = scheduledEndDate;
            // to ensure "constraints" is required (not null)
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for CompetitionReducedAllOf and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "dependantOn", IsRequired = true, EmitDefaultValue = false)]
