...
namespace Ziqni
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompetitionReducedAllOf :  IEquatable<CompetitionReducedAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompetitionReducedAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompetitionReducedAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompetitionReducedAllOf" /> class.
        /// </summary>
        ...
        public CompetitionReducedAllOf(CompetitionType competitionType = default(CompetitionType), int numberOfRounds = default(int), string name = default(string), CompetitionStatus status = default(CompetitionStatus), List<Dependancy> dependantOn = default(List<Dependancy>), string entrantMemberType = default(string), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), List<string> tags = default(List<string>), List<string> constraints = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("numberOfRounds is a required property for CompetitionReducedAllOf and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CompetitionReducedAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for CompetitionReducedAllOf and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (dependantOn == null)
            {
                throw new InvalidDataException("dependantOn is a required property for CompetitionReducedAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledStartDate is a required property for CompetitionReducedAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledEndDate is a required property for CompetitionReducedAllOf and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for CompetitionReducedAllOf and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CompetitionReducedAllOf);
        }

        /// <summary>
        /// Returns true if CompetitionReducedAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CompetitionReducedAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompetitionReducedAllOf input)
        {
            if (input == null)
                return false;
