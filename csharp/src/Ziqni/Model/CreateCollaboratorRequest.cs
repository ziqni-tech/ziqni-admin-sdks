...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCollaboratorRequest")]
    public partial class CreateCollaboratorRequest : IEquatable<CreateCollaboratorRequest>, IValidatableObject
    {
        ...
        public CreateCollaboratorRequest(string email = default(string), List<string> addRoles = default(List<string>))
        {
            ...
            this.Email = email ?? throw new ArgumentNullException("email is a required property for CreateCollaboratorRequest and cannot be null");
            // to ensure "addRoles" is required (not null)
            this.AddRoles = addRoles ?? throw new ArgumentNullException("addRoles is a required property for CreateCollaboratorRequest and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "addRoles", IsRequired = true, EmitDefaultValue = false)]
