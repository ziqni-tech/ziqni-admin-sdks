...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContestAllOf :  IEquatable<ContestAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContestAllOf" /> class.
        /// </summary>
        ...
        public ContestAllOf(string competitionId = default(string), int row = default(int), string name = default(string), string description = default(string), string termsAndConditions = default(string), int round = default(int), RoundType roundType = default(RoundType), List<string> entrantsFromContest = default(List<string>), int maxNumberOfEntrants = default(int), int minNumberOfEntrants = default(int), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), TournamentStrategies strategies = default(TournamentStrategies), ContestStatus status = default(ContestStatus), List<string> constraints = default(List<string>), string icon = default(string), string banner = default(string), string bannerLowResolution = default(string), string bannerHighResolution = default(string))
        {
            ...
            if (row == null)
            {
                throw new InvalidDataException("row is a required property for ContestAllOf and cannot be null");
            }
            else
            {
                this.Row = row;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ContestAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (round == null)
            {
                throw new InvalidDataException("round is a required property for ContestAllOf and cannot be null");
            }
            else
            {
                this.Round = round;
            ...
            if (roundType == null)
            {
                throw new InvalidDataException("roundType is a required property for ContestAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("entrantsFromContest is a required property for ContestAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("minNumberOfEntrants is a required property for ContestAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledStartDate is a required property for ContestAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledEndDate is a required property for ContestAllOf and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ContestAllOf and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for ContestAllOf and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ContestAllOf);
        }

        /// <summary>
        /// Returns true if ContestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ContestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContestAllOf input)
        {
            if (input == null)
                return false;
