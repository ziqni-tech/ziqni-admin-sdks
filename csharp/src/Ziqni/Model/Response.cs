...
namespace Ziqni.Model
{
    ...
    public partial class Response : IEquatable<Response>, IValidatableObject
    {
        ...
        public Response(MetaExtended meta = default(MetaExtended), List<Dictionary<string, Object>> results = default(List<Dictionary<string, Object>>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for Response and cannot be null");
