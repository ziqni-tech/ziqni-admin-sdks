...
namespace Ziqni.Model
{
    ...
    public partial class EventResponse : IEquatable<EventResponse>, IValidatableObject
    {
        ...
        public EventResponse(MetaExtended meta = default(MetaExtended), List<Event> results = default(List<Event>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for EventResponse and cannot be null");
