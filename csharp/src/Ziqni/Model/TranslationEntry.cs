...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationEntry")]
    public partial class TranslationEntry : IEquatable<TranslationEntry>, IValidatableObject
    {
        ...
        public TranslationEntry(string fieldName = default(string), string text = default(string))
        {
            ...
            this.FieldName = fieldName ?? throw new ArgumentNullException("fieldName is a required property for TranslationEntry and cannot be null");
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text is a required property for TranslationEntry and cannot be null");
        }
