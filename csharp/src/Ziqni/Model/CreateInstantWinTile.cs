...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateInstantWinTile :  IEquatable<CreateInstantWinTile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateInstantWinTile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateInstantWinTile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateInstantWinTile" /> class.
        /// </summary>
        ...
        public CreateInstantWinTile(string icon = default(string), string text = default(string), List<string> contraints = default(List<string>), CreateRewardRequest reward = default(CreateRewardRequest), GridLocation location = default(GridLocation), double probability = default(double))
        {
            // to ensure "icon" is required (not null)
            if (icon == null)
            {
                throw new InvalidDataException("icon is a required property for CreateInstantWinTile and cannot be null");
            }
            else
            {
                this.Icon = icon;
            ...
            if (probability == null)
            {
                throw new InvalidDataException("probability is a required property for CreateInstantWinTile and cannot be null");
            }
            else
            {
        ...
        public CreateRewardRequest Reward { get; set; }
        ...
        {
            return this.Equals(input as CreateInstantWinTile);
        }

        /// <summary>
        /// Returns true if CreateInstantWinTile instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateInstantWinTile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateInstantWinTile input)
        {
            if (input == null)
                return false;
