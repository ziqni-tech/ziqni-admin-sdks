...
namespace Ziqni
{
    ...
    public partial class Achievement :  IEquatable<Achievement>, IValidatableObject
    {
        ...
        public Achievement(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string description = default(string), string termsAndConditions = default(string), string icon = default(string), Scheduling scheduling = default(Scheduling), int maxNumberOfIssues = default(int), AchievementStatus? status = default(AchievementStatus?), List<string> constraints = default(List<string>), DependantOn achievementDependencies = default(DependantOn), DependantOn memberTagsFilter = default(DependantOn), DependantOn productTagsFilter = default(DependantOn))
        {
            ...
            if (spaceName == null)
            {
                throw new InvalidDataException("spaceName is a required property for Achievement and cannot be null");
            }
            else
            {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for Achievement and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Achievement and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (icon == null)
            {
                throw new InvalidDataException("icon is a required property for Achievement and cannot be null");
            }
            else
            {
                this.Icon = icon;
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for Achievement and cannot be null");
            }
            else
            {
