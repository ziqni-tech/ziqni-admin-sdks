...
namespace Ziqni.Model
{
    ...
    public partial class ActionType : IEquatable<ActionType>, IValidatableObject
    {
        /// <summary>
        ...
        public ActionType(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string key = default(string), string description = default(string), List<string> constraints = default(List<string>), string unitOfMeasure = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ActionType and cannot be null");
            // to ensure "spaceName" is required (not null)
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for ActionType and cannot be null");
            this.Created = created;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ActionType and cannot be null");
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for ActionType and cannot be null");
            // to ensure "constraints" is required (not null)
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for ActionType and cannot be null");
            // to ensure "unitOfMeasure" is required (not null)
            this.UnitOfMeasure = unitOfMeasure ?? throw new ArgumentNullException("unitOfMeasure is a required property for ActionType and cannot be null");
        ...
        {
            return this.Equals(input as ActionType);
        }

        /// <summary>
        /// Returns true if ActionType instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionType input)
        {
            if (input == null)
                return false;
