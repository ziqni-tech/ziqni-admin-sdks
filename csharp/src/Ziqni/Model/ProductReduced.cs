...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductReduced")]
    public partial class ProductReduced : IEquatable<ProductReduced>, IValidatableObject
    {
        ...
        public ProductReduced(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), string name = default(string), string productRefId = default(string), List<string> tags = default(List<string>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ProductReduced and cannot be null");
            // to ensure "spaceName" is required (not null)
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for ProductReduced and cannot be null");
            this.Created = created;
            // to ensure "productRefId" is required (not null)
            this.ProductRefId = productRefId ?? throw new ArgumentNullException("productRefId is a required property for ProductReduced and cannot be null");
            this.Name = name;
            this.Tags = tags;
        }
