...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberAchievementCount_allOf")]
    public partial class MemberAchievementCountAllOf : IEquatable<MemberAchievementCountAllOf>, IValidatableObject
    {
        ...
        public MemberAchievementCountAllOf(string name = default(string), string memberId = default(string), string memberRefId = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for MemberAchievementCountAllOf and cannot be null");
            // to ensure "memberId" is required (not null)
            this.MemberId = memberId ?? throw new ArgumentNullException("memberId is a required property for MemberAchievementCountAllOf and cannot be null");
            // to ensure "memberRefId" is required (not null)
            this.MemberRefId = memberRefId ?? throw new ArgumentNullException("memberRefId is a required property for MemberAchievementCountAllOf and cannot be null");
        }
