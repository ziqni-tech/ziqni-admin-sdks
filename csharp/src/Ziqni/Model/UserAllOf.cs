...
namespace Ziqni.Model
{
    ...
    public partial class UserAllOf : IEquatable<UserAllOf>, IValidatableObject
    {
        ...
        public UserAllOf(string firstName = default(string), string lastName = default(string), string email = default(string), List<string> constraints = default(List<string>), List<string> spaces = default(List<string>))
        {
            ...
            this.Email = email ?? throw new ArgumentNullException("email is a required property for UserAllOf and cannot be null");
            // to ensure "constraints" is required (not null)
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for UserAllOf and cannot be null");
