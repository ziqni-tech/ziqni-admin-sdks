...
namespace Ziqni.Model
{
    ...
    public partial class TournamentStrategies :  IEquatable<TournamentStrategies>, IValidatableObject
    {
        ...
        public TournamentStrategies(StrategyType strategyType = default(StrategyType), RankingStrategy rankingStrategy = default(RankingStrategy), ScoringStrategy scoringStrategy = default(ScoringStrategy))
        {
            ...
            {
                throw new InvalidDataException("strategyType is a required property for TournamentStrategies and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("rankingStrategy is a required property for TournamentStrategies and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scoringStrategy is a required property for TournamentStrategies and cannot be null");
            }
            else
            {
