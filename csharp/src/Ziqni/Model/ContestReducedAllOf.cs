...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContestReducedAllOf :  IEquatable<ContestReducedAllOf>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContestReducedAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContestReducedAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContestReducedAllOf" /> class.
        /// </summary>
        ...
        public ContestReducedAllOf(string competitionId = default(string), int row = default(int), string name = default(string), int round = default(int), int groupStage = default(int), List<string> entrantsFromContest = default(List<string>), ContestStatus status = default(ContestStatus), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), List<string> tags = default(List<string>), List<RewardReduced> rewards = default(List<RewardReduced>))
        {
            // to ensure "competitionId" is required (not null)
            if (competitionId == null)
            {
                throw new InvalidDataException("competitionId is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
            ...
            if (row == null)
            {
                throw new InvalidDataException("row is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
                this.Row = row;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (round == null)
            {
                throw new InvalidDataException("round is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
                this.Round = round;
            ...
            // to ensure "groupStage" is required (not null)
            if (groupStage == null)
            {
                throw new InvalidDataException("groupStage is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("entrantsFromContest is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("scheduledStartDate is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledEndDate is a required property for ContestReducedAllOf and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="groupStage", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as ContestReducedAllOf);
        }

        /// <summary>
        /// Returns true if ContestReducedAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ContestReducedAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContestReducedAllOf input)
        {
            if (input == null)
                return false;
