...
namespace Ziqni.Model
{
    ...
    public partial class EntrantCountResponse :  IEquatable<EntrantCountResponse>, IValidatableObject
    {
        ...
        {
            // to ensure "numberOfRecords" is required (not null)
            if (numberOfRecords == null)
            {
                throw new InvalidDataException("numberOfRecords is a required property for EntrantCountResponse and cannot be null");
            }
            else
            {
            ...
            if (downloadUrl == null)
            {
                throw new InvalidDataException("downloadUrl is a required property for EntrantCountResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="numberOfRecords", EmitDefaultValue=true)]
