...
namespace Ziqni.Model
{
    ...
    public partial class AwardAllOf :  IEquatable<AwardAllOf>, IValidatableObject
    {
        ...
        public AwardAllOf(string memberId = default(string), string rewardId = default(string), RewardTypeReduced rewardType = default(RewardTypeReduced), string rewardRank = default(string), double rewardValue = default(double), int delay = default(int), EntityType entityType = default(EntityType), string entityId = default(string), DateTime pointInTime = default(DateTime), int period = default(int), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), List<string> constraints = default(List<string>), DateTime claimedTimestamp = default(DateTime), string memberRefId = default(string))
        {
            ...
            if (memberId == null)
            {
                throw new InvalidDataException("memberId is a required property for AwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (rewardId == null)
            {
                throw new InvalidDataException("rewardId is a required property for AwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (rewardType == null)
            {
                throw new InvalidDataException("rewardType is a required property for AwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (rewardRank == null)
            {
                throw new InvalidDataException("rewardRank is a required property for AwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (rewardValue == null)
            {
                throw new InvalidDataException("rewardValue is a required property for AwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (entityType == null)
            {
                throw new InvalidDataException("entityType is a required property for AwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (entityId == null)
            {
                throw new InvalidDataException("entityId is a required property for AwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for AwardAllOf and cannot be null");
            }
            else
            {
