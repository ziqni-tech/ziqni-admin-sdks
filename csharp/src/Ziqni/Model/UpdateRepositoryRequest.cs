...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateRepositoryRequest")]
    public partial class UpdateRepositoryRequest : IEquatable<UpdateRepositoryRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRepositoryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRepositoryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRepositoryRequest" /> class.
        /// </summary>
        ...
        public UpdateRepositoryRequest(string id = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string description = default(string), List<string> addConstraints = default(List<string>), List<string> removeConstraints = default(List<string>), HostingOptions hostingOptions = default(HostingOptions))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpdateRepositoryRequest and cannot be null");
        ...
        {
            return this.Equals(input as UpdateRepositoryRequest);
        }

        /// <summary>
        /// Returns true if UpdateRepositoryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateRepositoryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateRepositoryRequest input)
        {
            if (input == null)
                return false;
