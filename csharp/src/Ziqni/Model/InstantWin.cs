...
namespace Ziqni.Model
{
    ...
    public partial class InstantWin :  IEquatable<InstantWin>, IValidatableObject
    {
        ...
        {
            // to ensure "instantWinType" is required (not null)
            if (instantWinType == null)
            {
                throw new InvalidDataException("instantWinType is a required property for InstantWin and cannot be null");
            }
            else
            {
            ...
            if (tiles == null)
            {
                throw new InvalidDataException("tiles is a required property for InstantWin and cannot be null");
            }
            else
            {
                this.Tiles = tiles;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for InstantWin and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (spaceName == null)
            {
                throw new InvalidDataException("spaceName is a required property for InstantWin and cannot be null");
            }
            else
            {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for InstantWin and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>integer</value>
        [DataMember(Name="instantWinType", EmitDefaultValue=true)]
