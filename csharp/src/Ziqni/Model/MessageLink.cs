...
namespace Ziqni.Model
{
    ...
    public partial class MessageLink : IEquatable<MessageLink>, IValidatableObject
    {
        ...
        public MessageLink(string entityId = default(string), string entityType = default(string), string linkType = default(string))
        {
            ...
            this.EntityId = entityId ?? throw new ArgumentNullException("entityId is a required property for MessageLink and cannot be null");
            // to ensure "entityType" is required (not null)
            this.EntityType = entityType ?? throw new ArgumentNullException("entityType is a required property for MessageLink and cannot be null");
            // to ensure "linkType" is required (not null)
            this.LinkType = linkType ?? throw new ArgumentNullException("linkType is a required property for MessageLink and cannot be null");
        }
        ...
        [DataMember(Name = "linkType", IsRequired = true, EmitDefaultValue = false)]
