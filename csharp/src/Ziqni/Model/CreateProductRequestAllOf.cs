...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateProductRequest_allOf")]
    public partial class CreateProductRequestAllOf : IEquatable<CreateProductRequestAllOf>, IValidatableObject
    {
        ...
        public CreateProductRequestAllOf(string name = default(string), string description = default(string), double adjustmentFactor = default(double), string icon = default(string), string productRefId = default(string), string productType = default(string), List<ActionTypeAdjustmentFactor> actionTypeAdjustmentFactors = default(List<ActionTypeAdjustmentFactor>), List<Translation> translations = default(List<Translation>))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateProductRequestAllOf and cannot be null");
            this.AdjustmentFactor = adjustmentFactor;
            // to ensure "productRefId" is required (not null)
            this.ProductRefId = productRefId ?? throw new ArgumentNullException("productRefId is a required property for CreateProductRequestAllOf and cannot be null");
