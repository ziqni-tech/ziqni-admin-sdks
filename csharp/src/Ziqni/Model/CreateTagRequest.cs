...
namespace Ziqni.Model
{
    ...
    public partial class CreateTagRequest :  IEquatable<CreateTagRequest>, IValidatableObject
    {
        ...
        public CreateTagRequest(string name = default(string), string key = default(string), string description = default(string), Dictionary<string, string> metadata = default(Dictionary<string, string>), List<string> entityTypes = default(List<string>))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateTagRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for CreateTagRequest and cannot be null");
            }
            else
            {
                this.Key = key;
            ...
            if (entityTypes == null)
            {
                throw new InvalidDataException("entityTypes is a required property for CreateTagRequest and cannot be null");
            }
            else
            {
