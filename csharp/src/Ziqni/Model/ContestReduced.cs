...
namespace Ziqni.Model
{
    ...
    public partial class ContestReduced :  IEquatable<ContestReduced>, IValidatableObject
    {
        ...
        public ContestReduced(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), string competitionId = default(string), int row = default(int), string name = default(string), int round = default(int), int groupStage = default(int), List<string> entrantsFromContest = default(List<string>), ContestStatus status = default(ContestStatus), DateTime scheduledStartDate = default(DateTime), DateTime scheduledEndDate = default(DateTime), List<string> tags = default(List<string>), List<RewardReduced> rewards = default(List<RewardReduced>))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ContestReduced and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (spaceName == null)
            {
                throw new InvalidDataException("spaceName is a required property for ContestReduced and cannot be null");
            }
            else
            {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for ContestReduced and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("competitionId is a required property for ContestReduced and cannot be null");
            }
            else
            {
            ...
            if (row == null)
            {
                throw new InvalidDataException("row is a required property for ContestReduced and cannot be null");
            }
            else
            {
                this.Row = row;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ContestReduced and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (round == null)
            {
                throw new InvalidDataException("round is a required property for ContestReduced and cannot be null");
            }
            else
            {
                this.Round = round;
            ...
            if (groupStage == null)
            {
                throw new InvalidDataException("groupStage is a required property for ContestReduced and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("entrantsFromContest is a required property for ContestReduced and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ContestReduced and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("scheduledStartDate is a required property for ContestReduced and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledEndDate is a required property for ContestReduced and cannot be null");
            }
            else
            {
