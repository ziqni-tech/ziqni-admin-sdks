...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateActionTypeRequest")]
    public partial class CreateActionTypeRequest : IEquatable<CreateActionTypeRequest>, IValidatableObject
    {
        ...
        public CreateActionTypeRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string key = default(string), string description = default(string), List<string> addConstraints = default(List<string>), string unitOfMeasure = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateActionTypeRequest and cannot be null");
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for CreateActionTypeRequest and cannot be null");
            // to ensure "unitOfMeasure" is required (not null)
            this.UnitOfMeasure = unitOfMeasure ?? throw new ArgumentNullException("unitOfMeasure is a required property for CreateActionTypeRequest and cannot be null");
