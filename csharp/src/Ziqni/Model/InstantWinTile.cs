...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstantWinTile :  IEquatable<InstantWinTile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstantWinTile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstantWinTile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstantWinTile" /> class.
        /// </summary>
        ...
        public InstantWinTile(string icon = default(string), string text = default(string), List<string> contraints = default(List<string>), RewardReduced reward = default(RewardReduced), GridLocation location = default(GridLocation), double probability = default(double))
        {
            // to ensure "icon" is required (not null)
            if (icon == null)
            {
                throw new InvalidDataException("icon is a required property for InstantWinTile and cannot be null");
            }
            else
            {
                this.Icon = icon;
            ...
            if (probability == null)
            {
                throw new InvalidDataException("probability is a required property for InstantWinTile and cannot be null");
            }
            else
            {
        ...
        public RewardReduced Reward { get; set; }
        ...
        {
            return this.Equals(input as InstantWinTile);
        }

        /// <summary>
        /// Returns true if InstantWinTile instances are equal
        /// </summary>
        /// <param name="input">Instance of InstantWinTile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstantWinTile input)
        {
            if (input == null)
                return false;
