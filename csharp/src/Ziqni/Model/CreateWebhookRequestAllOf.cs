...
namespace Ziqni.Model
{
    ...
    public partial class CreateWebhookRequestAllOf :  IEquatable<CreateWebhookRequestAllOf>, IValidatableObject
    {
        ...
        public CreateWebhookRequestAllOf(string postToUrl = default(string), List<string> triggers = default(List<string>), string description = default(string), string name = default(string), Dictionary<string, string> headers = default(Dictionary<string, string>))
        {
            ...
            if (postToUrl == null)
            {
                throw new InvalidDataException("postToUrl is a required property for CreateWebhookRequestAllOf and cannot be null");
            }
            else
            {
            ...
            if (triggers == null)
            {
                throw new InvalidDataException("triggers is a required property for CreateWebhookRequestAllOf and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateWebhookRequestAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
