...
namespace Ziqni.Model
{
    ...
    public partial class MemberResponse : IEquatable<MemberResponse>, IValidatableObject
    {
        ...
        public MemberResponse(MetaExtended meta = default(MetaExtended), List<Member> results = default(List<Member>), List<Error> errors = default(List<Error>))
        {
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for MemberResponse and cannot be null");
