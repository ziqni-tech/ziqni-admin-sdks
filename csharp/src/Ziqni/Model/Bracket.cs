...
namespace Ziqni.Model
{
    ...
    public partial class Bracket : IEquatable<Bracket>, IValidatableObject
    {
        ...
        public Bracket(int rounds = default(int), List<ContestReduced> contests = default(List<ContestReduced>))
        {
            ...
            this.Contests = contests ?? throw new ArgumentNullException("contests is a required property for Bracket and cannot be null");
        }
        ...
        [DataMember(Name = "rounds", IsRequired = true, EmitDefaultValue = false)]
        public int Rounds { get; set; }

        /// <summary>
        /// Gets or Sets Contests
        /// </summary>
        [DataMember(Name = "contests", IsRequired = true, EmitDefaultValue = false)]
