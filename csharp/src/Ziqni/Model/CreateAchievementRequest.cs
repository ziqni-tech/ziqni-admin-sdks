...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAchievementRequest")]
    public partial class CreateAchievementRequest : IEquatable<CreateAchievementRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAchievementRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAchievementRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAchievementRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateAchievementRequest);
        }

        /// <summary>
        /// Returns true if CreateAchievementRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAchievementRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAchievementRequest input)
        {
            if (input == null)
                return false;
