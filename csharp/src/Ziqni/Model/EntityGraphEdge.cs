...
namespace Ziqni.Model
{
    ...
    public partial class EntityGraphEdge :  IEquatable<EntityGraphEdge>, IValidatableObject
    {
        ...
        {
            // to ensure "ordering" is required (not null)
            if (ordering == null)
            {
                throw new InvalidDataException("ordering is a required property for EntityGraphEdge and cannot be null");
            }
            else
            {
