...
namespace Ziqni.Model
{
    ...
    public partial class CreateMemberRequestAllOf :  IEquatable<CreateMemberRequestAllOf>, IValidatableObject
    {
        ...
        public CreateMemberRequestAllOf(string name = default(string), string memberRefId = default(string), MemberType memberType = default(MemberType), string icon = default(string), List<string> teamMembers = default(List<string>), List<string> addConstraints = default(List<string>), string timeZoneOffset = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateMemberRequestAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (memberRefId == null)
            {
                throw new InvalidDataException("memberRefId is a required property for CreateMemberRequestAllOf and cannot be null");
            }
            else
            {
            ...
            if (memberType == null)
            {
                throw new InvalidDataException("memberType is a required property for CreateMemberRequestAllOf and cannot be null");
            }
            else
            {
