...
namespace Ziqni.Model
{
    ...
    public partial class UpdateConnectionRequest : IEquatable<UpdateConnectionRequest>, IValidatableObject
    {
        ...
        public UpdateConnectionRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), string id = default(string), string name = default(string), string description = default(string), List<string> constraints = default(List<string>), string transformerId = default(string), ConnectionType? connectionType = default(ConnectionType?), string secret = default(string), string user = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpdateConnectionRequest and cannot be null");
