...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MemberAllOf :  IEquatable<MemberAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public MemberAllOf(string name = default(string), string memberRefId = default(string), MemberType memberType = default(MemberType), string icon = default(string), List<string> teamMembers = default(List<string>), List<string> constraints = default(List<string>), string timeZoneOffset = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for MemberAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (memberRefId == null)
            {
                throw new InvalidDataException("memberRefId is a required property for MemberAllOf and cannot be null");
            }
            else
            {
            ...
            if (memberType == null)
            {
                throw new InvalidDataException("memberType is a required property for MemberAllOf and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as MemberAllOf);
        }

        /// <summary>
        /// Returns true if MemberAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MemberAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MemberAllOf input)
        {
            if (input == null)
                return false;
