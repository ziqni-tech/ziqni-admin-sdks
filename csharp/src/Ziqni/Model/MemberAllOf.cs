...
namespace Ziqni
{
    ...
    public partial class MemberAllOf :  IEquatable<MemberAllOf>, IValidatableObject
    {
        ...
        public MemberAllOf(string name = default(string), string memberRefId = default(string), MemberType memberType = default(MemberType), List<string> teamMembers = default(List<string>), List<string> constraints = default(List<string>), string timeZoneOffset = default(string))
        {
