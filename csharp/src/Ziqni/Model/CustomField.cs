...
namespace Ziqni.Model
{
    ...
    public partial class CustomField : IEquatable<CustomField>, IValidatableObject
    {
        ...
        public CustomField(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), string name = default(string), string key = default(string), string description = default(string), FieldType fieldType = default(FieldType), AppliesTo appliesTo = default(AppliesTo), List<string> constraints = default(List<string>))
        {
            ...
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for CustomField and cannot be null");
            ...
            this.Key = key ?? throw new ArgumentNullException("key is a required property for CustomField and cannot be null");
