...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateConnectionRequest_allOf")]
    public partial class CreateConnectionRequestAllOf : IEquatable<CreateConnectionRequestAllOf>, IValidatableObject
    {
        ...
        public CreateConnectionRequestAllOf(string name = default(string), string description = default(string), List<string> constraints = default(List<string>), string transformerId = default(string), ConnectionType connectionType = default(ConnectionType), string secret = default(string), string user = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateConnectionRequestAllOf and cannot be null");
