...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateConnectionRequestAllOf :  IEquatable<CreateConnectionRequestAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateConnectionRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateConnectionRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateConnectionRequestAllOf" /> class.
        /// </summary>
        ...
        public CreateConnectionRequestAllOf(string name = default(string), string description = default(string), List<string> constraints = default(List<string>), string transformerId = default(string), ConnectionType connectionType = default(ConnectionType), string secret = default(string), string user = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateConnectionRequestAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("connectionType is a required property for CreateConnectionRequestAllOf and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateConnectionRequestAllOf {\n");
        ...
        {
            return this.Equals(input as CreateConnectionRequestAllOf);
        }

        /// <summary>
        /// Returns true if CreateConnectionRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateConnectionRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateConnectionRequestAllOf input)
        {
            if (input == null)
                return false;
