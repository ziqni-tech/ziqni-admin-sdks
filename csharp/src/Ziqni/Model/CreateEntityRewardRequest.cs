...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateEntityRewardRequest")]
    public partial class CreateEntityRewardRequest : IEquatable<CreateEntityRewardRequest>, IValidatableObject
    {
        ...
        public CreateEntityRewardRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), RewardEntityType entityType = default(RewardEntityType), string entityId = default(string), string name = default(string), string description = default(string), string rewardRank = default(string), double rewardValue = default(double), string icon = default(string), int issueLimit = default(int), int delay = default(int), DateTime pointInTime = default(DateTime), int period = default(int), List<Translation> translations = default(List<Translation>), List<string> constraints = default(List<string>), string rewardTypeId = default(string))
        {
            ...
            this.EntityId = entityId ?? throw new ArgumentNullException("entityId is a required property for CreateEntityRewardRequest and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateEntityRewardRequest and cannot be null");
            // to ensure "rewardRank" is required (not null)
            this.RewardRank = rewardRank ?? throw new ArgumentNullException("rewardRank is a required property for CreateEntityRewardRequest and cannot be null");
            this.RewardValue = rewardValue;
            // to ensure "constraints" is required (not null)
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for CreateEntityRewardRequest and cannot be null");
            // to ensure "rewardTypeId" is required (not null)
            this.RewardTypeId = rewardTypeId ?? throw new ArgumentNullException("rewardTypeId is a required property for CreateEntityRewardRequest and cannot be null");
