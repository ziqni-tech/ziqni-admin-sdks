...
namespace Ziqni.Model
{
    ...
    /// RewardReducedAllOf
    /// </summary>
    [DataContract(Name = "RewardReduced_allOf")]
    public partial class RewardReducedAllOf : IEquatable<RewardReducedAllOf>, IValidatableObject
    {
        ...
        public RewardReducedAllOf(string rewardRank = default(string), string name = default(string), double rewardValue = default(double), string rewardType = default(string), string rewardTypeId = default(string))
        {
            ...
            this.RewardRank = rewardRank ?? throw new ArgumentNullException("rewardRank is a required property for RewardReducedAllOf and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for RewardReducedAllOf and cannot be null");
            this.RewardValue = rewardValue;
            // to ensure "rewardType" is required (not null)
            this.RewardType = rewardType ?? throw new ArgumentNullException("rewardType is a required property for RewardReducedAllOf and cannot be null");
            // to ensure "rewardTypeId" is required (not null)
            this.RewardTypeId = rewardTypeId ?? throw new ArgumentNullException("rewardTypeId is a required property for RewardReducedAllOf and cannot be null");
        }
