...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateEntityRewardRequest")]
    public partial class UpdateEntityRewardRequest : IEquatable<UpdateEntityRewardRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEntityRewardRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateEntityRewardRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEntityRewardRequest" /> class.
        /// </summary>
        ...
        public UpdateEntityRewardRequest(string id = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), RewardEntityType? entityType = default(RewardEntityType?), string entityId = default(string), string name = default(string), string description = default(string), string rewardRank = default(string), double rewardValue = default(double), string icon = default(string), int issueLimit = default(int), int delay = default(int), DateTime pointInTime = default(DateTime), int period = default(int), List<Translation> translations = default(List<Translation>), List<string> addConstraints = default(List<string>), List<string> removeConstraints = default(List<string>), string rewardTypeId = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpdateEntityRewardRequest and cannot be null");
        ...
        {
            return this.Equals(input as UpdateEntityRewardRequest);
        }

        /// <summary>
        /// Returns true if UpdateEntityRewardRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEntityRewardRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEntityRewardRequest input)
        {
            if (input == null)
                return false;
