...
namespace Ziqni
{
    ...
    public partial class UnitOfMeasureAllOf :  IEquatable<UnitOfMeasureAllOf>, IValidatableObject
    {
        ...
        public UnitOfMeasureAllOf(string name = default(string), string key = default(string), string description = default(string), string isoCode = default(string), string symbol = default(string), double multiplier = default(double), UnitOfMeasureType unitOfMeasureType = default(UnitOfMeasureType))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for UnitOfMeasureAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for UnitOfMeasureAllOf and cannot be null");
            }
            else
            {
                this.Key = key;
            ...
            if (multiplier == null)
            {
                throw new InvalidDataException("multiplier is a required property for UnitOfMeasureAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("unitOfMeasureType is a required property for UnitOfMeasureAllOf and cannot be null");
            }
            else
            {
