...
namespace Ziqni.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateComputeEngineRequest_allOf")]
    public partial class CreateComputeEngineRequestAllOf : IEquatable<CreateComputeEngineRequestAllOf>, IValidatableObject
    {
        ...
        public CreateComputeEngineRequestAllOf(string description = default(string), long version = default(long), string name = default(string), long uptime = default(long), List<string> constraints = default(List<string>), Dictionary<string, string> statistics = default(Dictionary<string, string>), int lastKnownStatusCode = default(int), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
            ...
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for CreateComputeEngineRequestAllOf and cannot be null");
