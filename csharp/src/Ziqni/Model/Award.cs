...
namespace Ziqni.Model
{
    ...
    public partial class Award : IEquatable<Award>, IValidatableObject
    {
        ...
        public Award(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), string memberId = default(string), string rewardId = default(string), RewardTypeReduced rewardType = default(RewardTypeReduced), string rewardRank = default(string), double rewardValue = default(double), int delay = default(int), EntityType entityType = default(EntityType), string entityId = default(string), DateTime pointInTime = default(DateTime), int period = default(int), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), List<string> constraints = default(List<string>), DateTime claimedTimestamp = default(DateTime), string memberRefId = default(string))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Award and cannot be null");
            // to ensure "spaceName" is required (not null)
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for Award and cannot be null");
            this.Created = created;
            // to ensure "memberId" is required (not null)
            this.MemberId = memberId ?? throw new ArgumentNullException("memberId is a required property for Award and cannot be null");
            // to ensure "rewardId" is required (not null)
            this.RewardId = rewardId ?? throw new ArgumentNullException("rewardId is a required property for Award and cannot be null");
            // to ensure "rewardType" is required (not null)
            this.RewardType = rewardType ?? throw new ArgumentNullException("rewardType is a required property for Award and cannot be null");
            // to ensure "rewardRank" is required (not null)
            this.RewardRank = rewardRank ?? throw new ArgumentNullException("rewardRank is a required property for Award and cannot be null");
            this.RewardValue = rewardValue;
            this.EntityType = entityType;
            // to ensure "entityId" is required (not null)
            this.EntityId = entityId ?? throw new ArgumentNullException("entityId is a required property for Award and cannot be null");
            // to ensure "constraints" is required (not null)
            this.Constraints = constraints ?? throw new ArgumentNullException("constraints is a required property for Award and cannot be null");
            this.Delay = delay;
