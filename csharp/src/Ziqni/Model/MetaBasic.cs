...
namespace Ziqni.Model
{
    ...
    public partial class MetaBasic :  IEquatable<MetaBasic>, IValidatableObject
    {
        ...
        public MetaBasic(string objectType = default(string), int totalRecords = default(int), int resultCount = default(int), int errorCount = default(int))
        {
            ...
            if (objectType == null)
            {
                throw new InvalidDataException("objectType is a required property for MetaBasic and cannot be null");
            }
            else
            {
            ...
            if (resultCount == null)
            {
                throw new InvalidDataException("resultCount is a required property for MetaBasic and cannot be null");
            }
            else
            {
            ...
            if (errorCount == null)
            {
                throw new InvalidDataException("errorCount is a required property for MetaBasic and cannot be null");
            }
            else
            {
