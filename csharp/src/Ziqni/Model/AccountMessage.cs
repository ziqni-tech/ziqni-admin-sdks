...
namespace Ziqni.Model
{
    ...
    /// AccountMessage
    /// </summary>
    [DataContract(Name = "AccountMessage")]
    public partial class AccountMessage : IEquatable<AccountMessage>, IValidatableObject
    {
        ...
        public AccountMessage(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<string> tags = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), DateTime expiry = default(DateTime), EventRefType eventRefType = default(EventRefType), string eventRefId = default(string), MessageType messageType = default(MessageType), string subject = default(string), string body = default(string), MessageStatus status = default(MessageStatus), string userId = default(string), List<MessageLink> links = default(List<MessageLink>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for AccountMessage and cannot be null");
            // to ensure "spaceName" is required (not null)
            this.SpaceName = spaceName ?? throw new ArgumentNullException("spaceName is a required property for AccountMessage and cannot be null");
            this.Created = created;
            this.EventRefType = eventRefType;
            // to ensure "eventRefId" is required (not null)
            this.EventRefId = eventRefId ?? throw new ArgumentNullException("eventRefId is a required property for AccountMessage and cannot be null");
            this.MessageType = messageType;
            // to ensure "subject" is required (not null)
            this.Subject = subject ?? throw new ArgumentNullException("subject is a required property for AccountMessage and cannot be null");
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for AccountMessage and cannot be null");
            this.Status = status;
            // to ensure "userId" is required (not null)
            this.UserId = userId ?? throw new ArgumentNullException("userId is a required property for AccountMessage and cannot be null");
            // to ensure "links" is required (not null)
            this.Links = links ?? throw new ArgumentNullException("links is a required property for AccountMessage and cannot be null");
