...
namespace Ziqni.Model
{
    ...
    public partial class CreateActionTypeRequestAllOf :  IEquatable<CreateActionTypeRequestAllOf>, IValidatableObject
    {
        ...
        public CreateActionTypeRequestAllOf(string name = default(string), string key = default(string), string description = default(string), List<string> addConstraints = default(List<string>), string unitOfMeasure = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateActionTypeRequestAllOf and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for CreateActionTypeRequestAllOf and cannot be null");
            }
            else
            {
                this.Key = key;
            ...
            {
                throw new InvalidDataException("unitOfMeasure is a required property for CreateActionTypeRequestAllOf and cannot be null");
            }
            else
            {
