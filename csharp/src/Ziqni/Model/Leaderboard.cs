...
namespace Ziqni
{
    ...
    public partial class Leaderboard :  IEquatable<Leaderboard>, IValidatableObject
    {
        ...
        public Leaderboard(string id = default(string), string spaceName = default(string), DateTime created = default(DateTime), List<LeaderboardEntry> leaderboardEntries = default(List<LeaderboardEntry>), List<string> constraints = default(List<string>), int sequence = default(int))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Leaderboard and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (spaceName == null)
            {
                throw new InvalidDataException("spaceName is a required property for Leaderboard and cannot be null");
            }
            else
            {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for Leaderboard and cannot be null");
            }
            else
            {
            ...
            if (constraints == null)
            {
                throw new InvalidDataException("constraints is a required property for Leaderboard and cannot be null");
            }
            else
            {
