...
namespace Ziqni.Api
{
    ...
    /// </summary>
    public interface ILogEventsApi : IApiAccessor
    {
    ...
    public partial class LogEventsApi : ILogEventsApi
    {
        ...
        /// <returns></returns>
        public LogEventsApi(Ziqni.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<LogEventResponse> GetLogEventsByQueryWithHttpInfo (QueryRequest body = default(QueryRequest))
        {
            ...
            {
                Exception exception = ExceptionFactory("GetLogEventsByQuery", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<LogEventResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (LogEventResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(LogEventResponse)));
        }
