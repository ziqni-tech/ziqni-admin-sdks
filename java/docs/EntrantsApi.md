...
public class Example {
    public static void main(String[] args) {
        ...
        EntrantsApi apiInstance = new EntrantsApi(defaultClient);
        List<UpdateEntrantRequest> body = Arrays.asList(); // List<UpdateEntrantRequest> | Updates the status of the Entrants
        try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**List&lt;UpdateEntrantRequest&gt;**](UpdateEntrantRequest.md)| Updates the status of the Entrants | [optional]
