...
> CompletableFuture<ModelApiResponse> createWallets(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<CreateWalletRequest> body = Arrays.asList(); // List<CreateWalletRequest> | Create Wallets in the Ziqni database
        try {
            CompletableFuture<ModelApiResponse> result = apiInstance.createWallets(body);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling WalletsApi#createWallets");
...
------------- | ------------- | ------------- | -------------
 **body** | [**List&lt;CreateWalletRequest&gt;**](CreateWalletRequest.md)| Create Wallets in the Ziqni database |
...
## createWalletsWithHttpInfo

> CompletableFuture<ApiResponse<ModelApiResponse>> createWallets createWalletsWithHttpInfo(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<CreateWalletRequest> body = Arrays.asList(); // List<CreateWalletRequest> | Create Wallets in the Ziqni database
        try {
            CompletableFuture<ApiResponse<ModelApiResponse>> response = apiInstance.createWalletsWithHttpInfo(body);
...
> CompletableFuture<ModelApiResponse> deleteWallets(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<ModelApiResponse> result = apiInstance.deleteWallets(id);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling WalletsApi#deleteWallets");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## deleteWalletsWithHttpInfo

> CompletableFuture<ApiResponse<ModelApiResponse>> deleteWallets deleteWalletsWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<String> id = Arrays.asList(); // List<String> | The unique identifiers of the resources
        try {
            CompletableFuture<ApiResponse<ModelApiResponse>> response = apiInstance.deleteWalletsWithHttpInfo(id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<WalletResponse> result = apiInstance.getWallets(id, limit, skip);
            System.out.println(result.get());
        } catch (ApiException e) {
...
## getWalletsWithHttpInfo

> CompletableFuture<ApiResponse<WalletResponse>> getWallets getWalletsWithHttpInfo(id, limit, skip)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer skip = 56; // Integer | Skip the returned records found and return the next batch of records
        try {
            CompletableFuture<ApiResponse<WalletResponse>> response = apiInstance.getWalletsWithHttpInfo(id, limit, skip);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
> CompletableFuture<ModelApiResponse> updateWallets(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        WalletsApi apiInstance = new WalletsApi(defaultClient);
        List<UpdateWalletRequest> body = Arrays.asList(); // List<UpdateWalletRequest> | Update Wallets in the Ziqni database.
        try {
            CompletableFuture<ModelApiResponse> result = apiInstance.updateWallets(body);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling WalletsApi#updateWallets");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**List&lt;UpdateWalletRequest&gt;**](UpdateWalletRequest.md)| Update Wallets in the Ziqni database. |
...
## updateWalletsWithHttpInfo

> CompletableFuture<ApiResponse<ModelApiResponse>> updateWallets updateWalletsWithHttpInfo(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<UpdateWalletRequest> body = Arrays.asList(); // List<UpdateWalletRequest> | Update Wallets in the Ziqni database.
        try {
            CompletableFuture<ApiResponse<ModelApiResponse>> response = apiInstance.updateWalletsWithHttpInfo(body);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
