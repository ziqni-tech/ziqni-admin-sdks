...
public class JackpotConfigsApiTest implements tests.utils.CompleteableFutureTestWrapper{

    private static final Logger logger = LoggerFactory.getLogger(CompetitionsApiTest.class);

    private final JackpotConfigsApiWs api;
    private final LoadJackpotConfigsData loadTestData;
    ...
    public JackpotConfigsApiTest() throws Exception {
        ApiClientFactoryUtil.initApiClientFactory(AdminApiClientConfigBuilder.build());
        this.api = ApiClientFactoryUtil.factory.getJackpotConfigsApi();
        this.loadTestData = new LoadJackpotConfigsData();
    ...
    @Test
    @Order(1)
    public void createJackpotConfigTest() throws ApiException {
        final var given = loadTestData.getCreateRequest();
        final var createRequestAsList = loadTestData.getCreateRequestAsList(given);

        ModelApiResponse response = $(api.createJackpotConfigs(createRequestAsList));
    ...
    public void getJackpotConfigSingleIdReturnOkTest() throws ApiException, InterruptedException {
        ...
        final var limit = 1;
        final var skip = 0;
        final var response = $(api.getJackpotConfigs(ids, limit, skip));
        ...
        assertEquals(request.getDropAmount(), item.getDropAmount(), "Found name should be equal to created previously");
