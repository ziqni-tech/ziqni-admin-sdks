...
import org.springframework.messaging.simp.stomp.StompHeaders;
    import com.ziqni.sdk.admin.model.ActionTypeResponse;
    ...
    import com.ziqni.sdk.admin.model.UpdateActionTypeRequest;
...
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
    public class ActionTypesApiWs {

    private final Duration memberVarReadTimeout;
    private final StreamingClient streamingClient;

    public ActionTypesApiWs(StreamingClient streamingClient, Duration readTimeout) {
    ...
    this.memberVarReadTimeout = readTimeout;
            ...
            */
            ...
            CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/gapi/createActionTypes", request);
            return result;
        }
            ...
            */
            ...
            CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/gapi/deleteActionTypes", request);
            return result;
        }
            ...
            */
            ...
            CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/gapi/deleteActionTypesByQuery", request);
            return result;
        }
...
queryParam.put("skip", skip);
            ...
            CompletableFuture<ActionTypeResponse> result = this.streamingClient.sendWithApiCallback("/gapi/getActionTypes", request);
            return result;
        }
            ...
            */
            ...
            CompletableFuture<ActionTypeResponse> result = this.streamingClient.sendWithApiCallback("/gapi/getActionTypesByQuery", request);
            return result;
        }
            ...
            */
            ...
            CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/gapi/updateActionTypes", request);
            return result;
        }
