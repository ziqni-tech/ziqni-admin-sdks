...
import org.springframework.messaging.simp.stomp.StompHeaders;
    import com.ziqni.sdk.admin.model.CreateCustomFieldRequest;
    import com.ziqni.sdk.admin.model.CustomFieldResponse;
    import com.ziqni.sdk.admin.model.ModelApiResponse;
    import com.ziqni.sdk.admin.model.QueryRequest;
    import com.ziqni.sdk.admin.model.UpdateCustomFieldRequest;
...
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
    public class CustomFieldsApiWs {

    private final Duration memberVarReadTimeout;
    private final StreamingClient streamingClient;

    public CustomFieldsApiWs(StreamingClient streamingClient, Duration readTimeout) {
    ...
    this.memberVarReadTimeout = readTimeout;
            ...
            */
            ...
            CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/gapi/createCustomFields", request);
            return result;
        }
            ...
            */
            ...
            CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/gapi/deleteCustomFields", request);
            return result;
        }
            ...
            */
            ...
            CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/gapi/deleteCustomFieldsByQuery", request);
            return result;
        }
...
queryParam.put("skip", skip);
            ...
            CompletableFuture<CustomFieldResponse> result = this.streamingClient.sendWithApiCallback("/gapi/getCustomFields", request);
            return result;
        }
            ...
            */
            ...
            CompletableFuture<CustomFieldResponse> result = this.streamingClient.sendWithApiCallback("/gapi/getCustomFieldsByQuery", request);
            return result;
        }
            ...
            */
            ...
            CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/gapi/updateCustomFields", request);
            return result;
        }
